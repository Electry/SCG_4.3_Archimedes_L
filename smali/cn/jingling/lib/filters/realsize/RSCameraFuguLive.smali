.class public Lcn/jingling/lib/filters/realsize/RSCameraFuguLive;
.super Lcn/jingling/lib/filters/realsize/RSLineFilter;
.source "RSCameraFuguLive.java"
...
.method public apply(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;[I)Z
    ...
    const-string v1, "curves/live_fugu.dat"

    invoke-direct {v0, p1, v1}, Lcn/jingling/lib/filters/Curve;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    iput-object v0, p0, Lcn/jingling/lib/filters/realsize/RSCameraFuguLive;->mCurve:Lcn/jingling/lib/filters/Curve;

    .line 18
    const-string v0, "layers/live_fugu"
    ...
    iput-object v0, p0, Lcn/jingling/lib/filters/realsize/RSCameraFuguLive;->mLayer:Landroid/graphics/Bitmap;
...
.method protected applyLine(Landroid/content/Context;[III)V
    ...
    .line 30
    iget-object v0, p0, Lcn/jingling/lib/filters/realsize/RSCameraFuguLive;->mCurve:Lcn/jingling/lib/filters/Curve;
    ...
    .line 33
    iget-object v0, p0, Lcn/jingling/lib/filters/realsize/RSCameraFuguLive;->mLayer:Landroid/graphics/Bitmap;

    invoke-virtual {p0, v0, p3, p4}, Lcn/jingling/lib/filters/realsize/RSCameraFuguLive;->getLayerPixels(Landroid/graphics/Bitmap;II)[I

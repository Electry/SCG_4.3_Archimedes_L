.class public Lcn/jingling/lib/filters/realsize/RSCameraMidwayLive;
.super Lcn/jingling/lib/filters/realsize/RSLineFilter;
.source "RSCameraMidwayLive.java"
...
.method public apply(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;[I)Z
    ...
    const-string v1, "curves/live_midway.dat"

    invoke-direct {v0, p1, v1}, Lcn/jingling/lib/filters/Curve;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    iput-object v0, p0, Lcn/jingling/lib/filters/realsize/RSCameraMidwayLive;->mCurve:Lcn/jingling/lib/filters/Curve;

    .line 18
    const-string v0, "layers/live_midway"
    ...
    iput-object v0, p0, Lcn/jingling/lib/filters/realsize/RSCameraMidwayLive;->mLayer:Landroid/graphics/Bitmap;
...
.method protected applyLine(Landroid/content/Context;[III)V
    ...
    .line 29
    .local v2, "w":I
    iget-object v0, p0, Lcn/jingling/lib/filters/realsize/RSCameraMidwayLive;->mLayer:Landroid/graphics/Bitmap;

    invoke-virtual {p0, v0, p3, p4}, Lcn/jingling/lib/filters/realsize/RSCameraMidwayLive;->getLayerPixels(Landroid/graphics/Bitmap;II)[I
    ...
    .line 35
    iget-object v0, p0, Lcn/jingling/lib/filters/realsize/RSCameraMidwayLive;->mCurve:Lcn/jingling/lib/filters/Curve;

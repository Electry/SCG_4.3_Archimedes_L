.class public Lcn/jingling/lib/filters/realsize/RSCameraHuiyi;
.super Lcn/jingling/lib/filters/realsize/RSLineFilter;
.source "RSCameraHuiyi.java"
...
.method public apply(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;[I)Z
    ...
    const-string v1, "curves/camera_huiyi.dat"

    invoke-direct {v0, p1, v1}, Lcn/jingling/lib/filters/Curve;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    iput-object v0, p0, Lcn/jingling/lib/filters/realsize/RSCameraHuiyi;->mCurve:Lcn/jingling/lib/filters/Curve;

    .line 19
    const-string v0, "layers/camera_huiyi_lb"
    ...
    iput-object v0, p0, Lcn/jingling/lib/filters/realsize/RSCameraHuiyi;->mLayer:Landroid/graphics/Bitmap;
...
.method protected applyLine(Landroid/content/Context;[III)V
    ...
    .line 31
    iget-object v0, p0, Lcn/jingling/lib/filters/realsize/RSCameraHuiyi;->mCurve:Lcn/jingling/lib/filters/Curve;
    ...
    .line 34
    iget-object v0, p0, Lcn/jingling/lib/filters/realsize/RSCameraHuiyi;->mLayer:Landroid/graphics/Bitmap;

    invoke-virtual {p0, v0, p3, p4}, Lcn/jingling/lib/filters/realsize/RSCameraHuiyi;->getLayerPixels(Landroid/graphics/Bitmap;II)[I

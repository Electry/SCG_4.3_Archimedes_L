.class public Lcn/jingling/lib/filters/realsize/RSCameraYazhiLive;
.super Lcn/jingling/lib/filters/realsize/RSLineFilter;
.source "RSCameraYazhiLive.java"
...
.method public apply(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;[I)Z
    ...
    const-string v1, "curves/live_yazhi.dat"

    invoke-direct {v0, p1, v1}, Lcn/jingling/lib/filters/Curve;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    iput-object v0, p0, Lcn/jingling/lib/filters/realsize/RSCameraYazhiLive;->mCurve:Lcn/jingling/lib/filters/Curve;

    .line 17
    const-string v0, "layers/live_yazhi"
    ...
    iput-object v0, p0, Lcn/jingling/lib/filters/realsize/RSCameraYazhiLive;->mLayer:Landroid/graphics/Bitmap;
...
.method protected applyLine(Landroid/content/Context;[III)V
    ...
    .line 28
    .local v2, "w":I
    iget-object v0, p0, Lcn/jingling/lib/filters/realsize/RSCameraYazhiLive;->mLayer:Landroid/graphics/Bitmap;

    invoke-virtual {p0, v0, p3, p4}, Lcn/jingling/lib/filters/realsize/RSCameraYazhiLive;->getLayerPixels(Landroid/graphics/Bitmap;II)[I
    ...
    .line 31
    iget-object v0, p0, Lcn/jingling/lib/filters/realsize/RSCameraYazhiLive;->mCurve:Lcn/jingling/lib/filters/Curve;

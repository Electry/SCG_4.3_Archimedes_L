.class public Lcn/jingling/lib/filters/realsize/RSCameraGuangyinLive;
.super Lcn/jingling/lib/filters/realsize/RSLineFilter;
.source "RSCameraGuangyinLive.java"
...
.method public apply(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;[I)Z
    ...
    const-string v1, "curves/live_guangyin1.dat"

    invoke-direct {v0, p1, v1}, Lcn/jingling/lib/filters/Curve;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    iput-object v0, p0, Lcn/jingling/lib/filters/realsize/RSCameraGuangyinLive;->mCurve1:Lcn/jingling/lib/filters/Curve;

    .line 18
    new-instance v0, Lcn/jingling/lib/filters/Curve;

    const-string v1, "curves/live_guangyin2.dat"

    invoke-direct {v0, p1, v1}, Lcn/jingling/lib/filters/Curve;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    iput-object v0, p0, Lcn/jingling/lib/filters/realsize/RSCameraGuangyinLive;->mCurve2:Lcn/jingling/lib/filters/Curve;

    .line 19
    const-string v0, "layers/live_guangyin"
    ...
    iput-object v0, p0, Lcn/jingling/lib/filters/realsize/RSCameraGuangyinLive;->mLayer:Landroid/graphics/Bitmap;
...
.method protected applyLine(Landroid/content/Context;[III)V
    ...
    .line 29
    .local v4, "w":I
    iget-object v0, p0, Lcn/jingling/lib/filters/realsize/RSCameraGuangyinLive;->mCurve1:Lcn/jingling/lib/filters/Curve;
    ...
    .line 32
    iget-object v0, p0, Lcn/jingling/lib/filters/realsize/RSCameraGuangyinLive;->mLayer:Landroid/graphics/Bitmap;

    invoke-virtual {p0, v0, p3, p4}, Lcn/jingling/lib/filters/realsize/RSCameraGuangyinLive;->getLayerPixels(Landroid/graphics/Bitmap;II)[I
    ...
    invoke-static {p2, v4, v0, v1}, Lcn/jingling/lib/filters/ImageProcessUtils;->saturationPs([IIII)[I

    .line 38
    iget-object v0, p0, Lcn/jingling/lib/filters/realsize/RSCameraGuangyinLive;->mCurve2:Lcn/jingling/lib/filters/Curve;

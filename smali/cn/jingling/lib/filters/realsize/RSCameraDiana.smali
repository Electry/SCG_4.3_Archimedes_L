.class public Lcn/jingling/lib/filters/realsize/RSCameraDiana;
.super Lcn/jingling/lib/filters/realsize/RSLineFilter;
.source "RSCameraDiana.java"
...
.method public apply(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;[I)Z
    ...
    const-string v1, "curves/camera_diana.dat"

    invoke-direct {v0, p1, v1}, Lcn/jingling/lib/filters/Curve;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    iput-object v0, p0, Lcn/jingling/lib/filters/realsize/RSCameraDiana;->mCurve:Lcn/jingling/lib/filters/Curve;

    .line 19
    const-string v0, "layers/camera_diana_lb"
    ...
    iput-object v0, p0, Lcn/jingling/lib/filters/realsize/RSCameraDiana;->mLayerLb:Landroid/graphics/Bitmap;
...
.method protected applyLine(Landroid/content/Context;[III)V
    ...
    .line 30
    .local v4, "w":I
    iget-object v0, p0, Lcn/jingling/lib/filters/realsize/RSCameraDiana;->mCurve:Lcn/jingling/lib/filters/Curve;
    ...
    .line 32
    iget-object v0, p0, Lcn/jingling/lib/filters/realsize/RSCameraDiana;->mLayerLb:Landroid/graphics/Bitmap;

    invoke-virtual {p0, v0, p3, p4}, Lcn/jingling/lib/filters/realsize/RSCameraDiana;->getLayerPixels(Landroid/graphics/Bitmap;II)[I

...
.field private static final PAINT_BLUR:Landroid/graphics/Paint;

.field private static final PAINT_DISABLED:Landroid/graphics/Paint;

.field private static final PAINT_GLOWCOLOR_FOCUSED:Landroid/graphics/Paint;

.field private static final PAINT_GLOWCOLOR_PRESSED:Landroid/graphics/Paint;

.field private static final TAG:Ljava/lang/String; = "Launcher.Utilities"

.field private static sIconHeight:F

.field private static sIconWidth:F

.field private static sTextureIconHEIGHT:I

.field private static sTextureIconWIDTH:I
...
.method static constructor <clinit>()V
    ...
    .line 25
    sput v0, Lledroid/utils/IconUtilities;->sIconWidth:F

    .line 26
    sput v0, Lledroid/utils/IconUtilities;->sIconHeight:F

    .line 27
    sput v1, Lledroid/utils/IconUtilities;->sTextureIconWIDTH:I

    .line 28
    sput v1, Lledroid/utils/IconUtilities;->sTextureIconHEIGHT:I
    ...
    sput-object v0, Lledroid/utils/IconUtilities;->PAINT_BLUR:Landroid/graphics/Paint;
    ...
    sput-object v0, Lledroid/utils/IconUtilities;->PAINT_GLOWCOLOR_PRESSED:Landroid/graphics/Paint;
    ...
    sput-object v0, Lledroid/utils/IconUtilities;->PAINT_GLOWCOLOR_FOCUSED:Landroid/graphics/Paint;
    ...
    sput-object v0, Lledroid/utils/IconUtilities;->PAINT_DISABLED:Landroid/graphics/Paint;
    ...
    sput-object v0, Lledroid/utils/IconUtilities;->OLD_BOUNDS:Landroid/graphics/Rect;
    ...
    sput-object v0, Lledroid/utils/IconUtilities;->CANVAS:Landroid/graphics/Canvas;

    .line 38
    sget-object v0, Lledroid/utils/IconUtilities;->CANVAS:Landroid/graphics/Canvas;
...
.method public static createIconBitmap(Landroid/graphics/Bitmap;Landroid/content/Context;)Landroid/graphics/Bitmap;
    ...
    .prologue
    .line 50
    sget v4, Lledroid/utils/IconUtilities;->sTextureIconWIDTH:I

    .line 51
    .local v4, "textureWidth":I
    sget v3, Lledroid/utils/IconUtilities;->sTextureIconHEIGHT:I
...
.method public static createIconBitmap(Landroid/graphics/drawable/Drawable;Landroid/content/Context;)Landroid/graphics/Bitmap;
    ...
    .prologue
    .line 74
    sget-object v18, Lledroid/utils/IconUtilities;->CANVAS:Landroid/graphics/Canvas;

    monitor-enter v18

    .line 75
    :try_start_0
    sget v17, Lledroid/utils/IconUtilities;->sIconWidth:F
    ...
    .line 76
    invoke-static/range {p1 .. p1}, Lledroid/utils/IconUtilities;->initStatics(Landroid/content/Context;)V

    .line 79
    :cond_0
    sget v16, Lledroid/utils/IconUtilities;->sIconWidth:F

    .line 80
    .local v16, "width":F
    sget v6, Lledroid/utils/IconUtilities;->sIconHeight:F
    ...
    :cond_3
    :goto_1
    sget v14, Lledroid/utils/IconUtilities;->sTextureIconWIDTH:I

    .line 115
    .local v14, "textureWidth":I
    sget v13, Lledroid/utils/IconUtilities;->sTextureIconHEIGHT:I
    ...
    sget-object v5, Lledroid/utils/IconUtilities;->CANVAS:Landroid/graphics/Canvas;
    ...
    .line 127
    .local v4, "bottom":I
    sget-object v17, Lledroid/utils/IconUtilities;->OLD_BOUNDS:Landroid/graphics/Rect;
...
.method public static drawDisabledBitmap(Landroid/graphics/Bitmap;Landroid/content/Context;)Landroid/graphics/Bitmap;
    ...
    .prologue
    .line 187
    sget-object v3, Lledroid/utils/IconUtilities;->CANVAS:Landroid/graphics/Canvas;

    monitor-enter v3

    .line 188
    :try_start_0
    sget v2, Lledroid/utils/IconUtilities;->sIconWidth:F
    ...
    .line 189
    invoke-static {p1}, Lledroid/utils/IconUtilities;->initStatics(Landroid/content/Context;)V
    ...
    sget-object v5, Lledroid/utils/IconUtilities;->PAINT_DISABLED:Landroid/graphics/Paint;
...
.method public static drawSelectedAllAppsBitmap(Landroid/graphics/Canvas;FFZLandroid/graphics/Bitmap;)V
    ...
    .line 139
    :try_start_0
    sget v4, Lledroid/utils/IconUtilities;->sIconWidth:F
    ...
    .line 149
    .local v3, "xy":[I
    sget-object v4, Lledroid/utils/IconUtilities;->PAINT_BLUR:Landroid/graphics/Paint;
    ...
    sget-object v4, Lledroid/utils/IconUtilities;->PAINT_GLOWCOLOR_PRESSED:Landroid/graphics/Paint;
    ...
    .line 153
    :cond_1
    sget-object v4, Lledroid/utils/IconUtilities;->PAINT_GLOWCOLOR_FOCUSED:Landroid/graphics/Paint;
    :try_end_1
...
.method private static initStatics(Landroid/content/Context;)V
    ...
    sput v4, Lledroid/utils/IconUtilities;->sIconWidth:F

    .line 210
    sget v4, Lledroid/utils/IconUtilities;->sIconWidth:F

    sput v4, Lledroid/utils/IconUtilities;->sIconHeight:F
    ...
    sput v4, Lledroid/utils/IconUtilities;->sTextureIconWIDTH:I

    .line 212
    sget v4, Lledroid/utils/IconUtilities;->sTextureIconWIDTH:I

    sput v4, Lledroid/utils/IconUtilities;->sTextureIconHEIGHT:I
    ...
    .line 222
    sget-object v4, Lledroid/utils/IconUtilities;->PAINT_DISABLED:Landroid/graphics/Paint;
...
.method public static resampleIconBitmap(Landroid/graphics/Bitmap;Landroid/content/Context;)Landroid/graphics/Bitmap;
    ...
    .prologue
    .line 172
    sget-object v2, Lledroid/utils/IconUtilities;->CANVAS:Landroid/graphics/Canvas;

    monitor-enter v2

    .line 173
    :try_start_0
    sget v1, Lledroid/utils/IconUtilities;->sIconWidth:F
    ...
    sget v3, Lledroid/utils/IconUtilities;->sIconWidth:F
    ...
    sget v3, Lledroid/utils/IconUtilities;->sIconHeight:F

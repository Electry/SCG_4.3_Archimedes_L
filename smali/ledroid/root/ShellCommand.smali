...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lledroid/root/ShellCommand$CommandResponse;,
...
# static fields
.field private static final CMD_END_MARK:Ljava/lang/String; = "SHELL COMMAND END"

.field private static final DEBUG:Z = false

.field private static final TAG:Ljava/lang/String; = "ShellCommand"
...
.field private mResponseCallback:Lledroid/root/ShellCommand$ShellCommandResponse;

.field private mTempFiles:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList",
            "<",
...
.field private mTransport:Lledroid/root/ICommandTransport;
...
.method public constructor <init>(Lledroid/root/ICommandTransport;)V
    ...
    .line 20
    iput-object v1, p0, Lledroid/root/ShellCommand;->mTransport:Lledroid/root/ICommandTransport;
    ...
    iput-object v0, p0, Lledroid/root/ShellCommand;->mCommand:Ljava/util/ArrayList;

    .line 22
    iput-object v1, p0, Lledroid/root/ShellCommand;->mResponseCallback:Lledroid/root/ShellCommand$ShellCommandResponse;
    ...
    iput-object v0, p0, Lledroid/root/ShellCommand;->mTempFiles:Ljava/util/ArrayList;

    .line 30
    iput-object p1, p0, Lledroid/root/ShellCommand;->mTransport:Lledroid/root/ICommandTransport;
...
.method static synthetic access$000(Lledroid/root/ShellCommand;)Lledroid/root/ShellCommand$ShellCommandResponse;
    .locals 1
    .param p0, "x0"    # Lledroid/root/ShellCommand;

    .prologue
    .line 14
    iget-object v0, p0, Lledroid/root/ShellCommand;->mResponseCallback:Lledroid/root/ShellCommand$ShellCommandResponse;

    return-object v0
.end method

.method static synthetic access$100(Lledroid/root/ShellCommand;)Lledroid/root/ICommandTransport;
    .locals 1
    .param p0, "x0"    # Lledroid/root/ShellCommand;

    .prologue
    .line 14
    iget-object v0, p0, Lledroid/root/ShellCommand;->mTransport:Lledroid/root/ICommandTransport;

    return-object v0
.end method

.method static synthetic access$200(Lledroid/root/ShellCommand;ILjava/lang/String;)V
    .locals 0
    .param p0, "x0"    # Lledroid/root/ShellCommand;
    .param p1, "x1"    # I
    ...
    .prologue
    .line 14
    invoke-direct {p0, p1, p2}, Lledroid/root/ShellCommand;->shellCommandResponse(ILjava/lang/String;)V

    return-void
.end method

.method private declared-synchronized execAsScriptBatch(I)Lledroid/root/ShellCommand;
    .locals 10
    .param p1, "exeId"    # I
    ...
    :try_start_0
    iget-object v7, p0, Lledroid/root/ShellCommand;->mCommand:Ljava/util/ArrayList;

    if-eqz v7, :cond_0

    iget-object v7, p0, Lledroid/root/ShellCommand;->mTransport:Lledroid/root/ICommandTransport;
    :try_end_0
    ...
    .line 144
    iget-object v7, p0, Lledroid/root/ShellCommand;->mTempFiles:Ljava/util/ArrayList;
...
.method private execCmdByCmd(I)V
    ...
    .line 93
    .local v0, "cmd":Ljava/lang/String;
    iget-object v3, p0, Lledroid/root/ShellCommand;->mCommand:Ljava/util/ArrayList;
    ...
    .line 99
    :cond_0
    iget-object v3, p0, Lledroid/root/ShellCommand;->mTransport:Lledroid/root/ICommandTransport;
    ...
    const-string v4, "echo \"SHELL COMMAND END\" \n"

    invoke-interface {v3, v4}, Lledroid/root/ICommandTransport;->write(Ljava/lang/String;)V
...
# virtual methods
.method public varargs declared-synchronized addCommand([Ljava/lang/String;)Lledroid/root/ShellCommand;
    .locals 5
...
.method public declared-synchronized exec()Lledroid/root/ShellCommand;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public declared-synchronized exec(I)Lledroid/root/ShellCommand;
    .locals 1
    .param p1, "exeId"    # I
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    :try_start_0
    iget-object v0, p0, Lledroid/root/ShellCommand;->mCommand:Ljava/util/ArrayList;
    ...
    .line 79
    invoke-direct {p0, p1}, Lledroid/root/ShellCommand;->execAsScriptBatch(I)Lledroid/root/ShellCommand;
    ...
    .line 81
    :cond_2
    invoke-direct {p0, p1}, Lledroid/root/ShellCommand;->execCmdByCmd(I)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method protected finalize()V
    ...
    .prologue
    .line 40
    iget-object v1, p0, Lledroid/root/ShellCommand;->mTempFiles:Ljava/util/ArrayList;
...
.method public declared-synchronized setResponseCallBack(Lledroid/root/ShellCommand$ShellCommandResponse;)V
    .locals 1
    ...
    .line 64
    :try_start_0
    iput-object p1, p0, Lledroid/root/ShellCommand;->mResponseCallback:Lledroid/root/ShellCommand$ShellCommandResponse;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public waitResponse(IJ)V
    ...
    .line 187
    iget-object v3, p0, Lledroid/root/ShellCommand;->mResponseCallback:Lledroid/root/ShellCommand$ShellCommandResponse;
    ...
    new-instance v3, Lledroid/root/ShellCommand$CommandResponse;

    invoke-direct {v3, p0, p0, p1}, Lledroid/root/ShellCommand$CommandResponse;-><init>(Lledroid/root/ShellCommand;Lledroid/root/ShellCommand;I)V

    invoke-direct {v2, v3}, Ljava/lang/Thread;-><init>(Ljava/lang/Runnable;)V

    .line 201
    .local v2, "relayThread":Ljava/lang/Thread;
    const/4 v3, 0x1
    ...
    iget-object v4, p0, Lledroid/root/ShellCommand;->mResponseCallback:Lledroid/root/ShellCommand$ShellCommandResponse;

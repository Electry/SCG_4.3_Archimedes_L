...
.method private palceSelfSuFileToSystem(Lledroid/root/ICommandTransport;Ljava/lang/String;)V
    ...
    const-string/jumbo v3, "mount -oremount,rw"
    ...
    const-string/jumbo v4, "mount -oremount,rw /system /system"
    ...
    const-string/jumbo v4, "mount -oremount,ro"
    ...
    const-string/jumbo v4, "mount -oremount,ro /system /system"
    ...
    invoke-virtual {v2, v4, v5}, Lledroid/root/ShellCommand;->waitResponse(J)V
...
.method public deployedIsUpToData()Z
    ...
    invoke-virtual {v1}, Lledroid/utils/AndroidResourceFile;->getLength()I

...
.method public static declared-synchronized launchLedroidService()V
    ...
    invoke-virtual {v5}, Lledroid/app/LedroidApplication;->getResources()Landroid/content/res/Resources;

    move-result-object v5

    sget-object v7, Lledroid/root/LedroidServiceLauncher;->sLedroidApplication:Lledroid/app/LedroidApplication;

    invoke-virtual {v7}, Lledroid/app/LedroidApplication;->getPackageName()Ljava/lang/String;
    ...
    invoke-virtual {v9}, Lledroid/app/LedroidApplication;->getFilesDir()Ljava/io/File;
    ...
    sget-wide v8, Lledroid/root/LedroidServiceLauncher;->sLedroidServiceInitTime:J
    ...
    sput-wide v8, Lledroid/root/LedroidServiceLauncher;->sLedroidServiceInitTime:J
...
.method private static removeAllOldVersionDex(I)V
    ...
    const-string/jumbo v9, "mount -oremount,rw /data /data"
    ...
    const-string/jumbo v10, "mount -oremount,rw"
    ...
    const-string/jumbo v10, "mount -oremount,ro /data /data"
    ...
    const-string/jumbo v10, "mount -oremount,ro"

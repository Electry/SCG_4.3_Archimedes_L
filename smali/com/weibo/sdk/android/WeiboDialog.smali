...
.method private parseDimens()Z
    ...
    :try_start_0
    const-string/jumbo v10, "values/dimens.xml"
    ...
    const-string/jumbo v10, "weibosdk_dialog_left_margin"
    ...
    :cond_3
    :try_start_7
    const-string/jumbo v10, "weibosdk_dialog_top_margin"
    ...
    :cond_5
    :try_start_9
    const-string/jumbo v10, "weibosdk_dialog_right_margin"
    ...
    .end local v8    # "value":Ljava/lang/String;
    :cond_6
    const-string/jumbo v10, "weibosdk_dialog_bottom_margin"
...
.method private setUpWebView()V
    ...
    iput-object v13, v0, Lcom/weibo/sdk/android/WeiboDialog;->webViewContainer:Landroid/widget/RelativeLayout;
    ...
    iput-object v13, v0, Lcom/weibo/sdk/android/WeiboDialog;->mWebView:Landroid/webkit/WebView;
    ...
    invoke-virtual {v13, v14}, Landroid/webkit/WebSettings;->setSavePassword(Z)V
    ...
    new-instance v14, Lcom/weibo/sdk/android/WeiboDialog$WeiboWebViewClient;

    const/4 v15, 0x0

    move-object/from16 v0, p0

    invoke-direct {v14, v0, v15}, Lcom/weibo/sdk/android/WeiboDialog$WeiboWebViewClient;-><init>(Lcom/weibo/sdk/android/WeiboDialog;Lcom/weibo/sdk/android/WeiboDialog$WeiboWebViewClient;)V
    ...
    iget-object v13, v0, Lcom/weibo/sdk/android/WeiboDialog;->mContext:Landroid/content/Context;

    move-object/from16 v0, p0

    iget-object v14, v0, Lcom/weibo/sdk/android/WeiboDialog;->mUrl:Ljava/lang/String;

    invoke-static {v13, v14}, Lcom/weibo/sdk/android/WeiboDialog;->synCookies(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-virtual {v13, v14}, Landroid/webkit/WebView;->setScrollBarStyle(I)V
    ...
    invoke-virtual {v13, v14}, Landroid/webkit/WebView;->setVisibility(I)V
    ...
    .line 144
    .local v9, "lp0":Landroid/widget/RelativeLayout$LayoutParams;
    move-object/from16 v0, p0

    iget-object v13, v0, Lcom/weibo/sdk/android/WeiboDialog;->mContent:Landroid/widget/RelativeLayout;
    ...
    .line 146
    .local v2, "asseets":Landroid/content/res/AssetManager;
    const/4 v7, 0x0
    ...
    .local v4, "density":F
    :try_start_0
    const-string/jumbo v13, "weibosdk_dialog_bg.9.png"
    ...
    iget-object v14, v0, Lcom/weibo/sdk/android/WeiboDialog;->mWebView:Landroid/webkit/WebView;

    invoke-virtual {v13, v14, v9}, Landroid/widget/RelativeLayout;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-virtual {v13, v14}, Landroid/widget/RelativeLayout;->setGravity(I)V
    ...
    .line 184
    sget v13, Lcom/weibo/sdk/android/WeiboDialog;->left_margin:I

    iput v13, v8, Landroid/widget/RelativeLayout$LayoutParams;->leftMargin:I
    ...
    .line 192
    :goto_3
    sget v13, Lcom/weibo/sdk/android/WeiboDialog;->right_margin:I
    ...
    sget v16, Lcom/weibo/sdk/android/WeiboDialog;->left_margin:I
    ...
    iget v14, v8, Landroid/widget/RelativeLayout$LayoutParams;->topMargin:I
    ...
    iget-object v14, v0, Lcom/weibo/sdk/android/WeiboDialog;->webViewContainer:Landroid/widget/RelativeLayout;
    ...
    invoke-direct {v10, v3, v13, v14, v15}, Landroid/graphics/drawable/NinePatchDrawable;-><init>(Landroid/graphics/Bitmap;[BLandroid/graphics/Rect;Ljava/lang/String;)V

    .line 166
    .local v10, "npd":Landroid/graphics/drawable/NinePatchDrawable;
    move-object/from16 v0, p0

    iget-object v13, v0, Lcom/weibo/sdk/android/WeiboDialog;->webViewContainer:Landroid/widget/RelativeLayout;

    invoke-virtual {v13, v10}, Landroid/widget/RelativeLayout;->setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    :try_end_6
    ...
    .end local v10    # "npd":Landroid/graphics/drawable/NinePatchDrawable;
    :catchall_0
    move-exception v13

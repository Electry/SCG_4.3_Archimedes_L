...
# static fields
.field private static final SERVER_URL_PRIX:Ljava/lang/String; = "https://upload.api.weibo.com/2/comments"
...
.method public byME(JJIILcom/weibo/sdk/android/api/WeiboAPI$SRC_FILTER;Lcom/weibo/sdk/android/net/RequestListener;)V
    ...
    .line 57
    const-string v1, "https://upload.api.weibo.com/2/comments/by_me.json"
...
.method public create(Ljava/lang/String;JZLcom/weibo/sdk/android/net/RequestListener;)V
    ...
    .line 165
    :goto_0
    const-string v1, "https://upload.api.weibo.com/2/comments/create.json"
...
.method public destroy(JLcom/weibo/sdk/android/net/RequestListener;)V
    ...
    .line 177
    const-string v1, "https://upload.api.weibo.com/2/comments/destroy.json"
...
.method public destroyBatch([JLcom/weibo/sdk/android/net/RequestListener;)V
    ...
    .line 194
    const-string v7, "https://upload.api.weibo.com/2/comments/sdestroy_batch.json"

    const-string v8, "POST"

    invoke-virtual {p0, v7, v5, v8, p2}, Lcom/weibo/sdk/android/api/CommentsAPI;->request(Ljava/lang/String;Lcom/weibo/sdk/android/WeiboParameters;Ljava/lang/String;Lcom/weibo/sdk/android/net/RequestListener;)V
...
.method public mentions(JJIILcom/weibo/sdk/android/api/WeiboAPI$AUTHOR_FILTER;Lcom/weibo/sdk/android/api/WeiboAPI$SRC_FILTER;Lcom/weibo/sdk/android/net/RequestListener;)V
    ...
    .line 128
    const-string v1, "https://upload.api.weibo.com/2/comments/mentions.json"
...
.method public reply(JJLjava/lang/String;ZZLcom/weibo/sdk/android/net/RequestListener;)V
    ...
    .line 214
    const-string/jumbo v1, "without_mention"
    ...
    .line 223
    :goto_1
    const-string v1, "https://upload.api.weibo.com/2/comments/reply.json"
...
.method public show(JJJIILcom/weibo/sdk/android/api/WeiboAPI$AUTHOR_FILTER;Lcom/weibo/sdk/android/net/RequestListener;)V
    ...
    .line 37
    const-string v1, "https://upload.api.weibo.com/2/comments/show.json"
...
.method public showBatch([JLcom/weibo/sdk/android/net/RequestListener;)V
    ...
    .line 145
    const-string v7, "https://upload.api.weibo.com/2/comments/show_batch.json"
...
.method public timeline(JJIIZLcom/weibo/sdk/android/net/RequestListener;)V
    ...
    .line 105
    :goto_0
    const-string v1, "https://upload.api.weibo.com/2/comments/timeline.json"
...
.method public toME(JJIILcom/weibo/sdk/android/api/WeiboAPI$AUTHOR_FILTER;Lcom/weibo/sdk/android/api/WeiboAPI$SRC_FILTER;Lcom/weibo/sdk/android/net/RequestListener;)V
    ...
    .line 80
    const-string v1, "https://upload.api.weibo.com/2/comments/to_me.json"

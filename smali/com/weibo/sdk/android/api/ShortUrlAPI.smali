...
# static fields
.field private static final SERVER_URL_PRIX:Ljava/lang/String; = "https://upload.api.weibo.com/2/short_url"
...
.method public clicks([Ljava/lang/String;Lcom/weibo/sdk/android/net/RequestListener;)V
    ...
    .line 64
    const-string/jumbo v3, "url_short"
    ...
    :cond_0
    const-string v3, "https://upload.api.weibo.com/2/short_url/clicks.json"
...
.method public commentCounts([Ljava/lang/String;Lcom/weibo/sdk/android/net/RequestListener;)V
    ...
    .end local v1    # "length":I
    :cond_0
    const-string v3, "https://upload.api.weibo.com/2/short_url/comment/counts.json"
...
.method public comments(Ljava/lang/String;JJIILcom/weibo/sdk/android/net/RequestListener;)V
    ...
    .line 167
    const-string v1, "https://upload.api.weibo.com/2/short_url/comment/comments.json"
...
.method public expand([Ljava/lang/String;Lcom/weibo/sdk/android/net/RequestListener;)V
    ...
    .end local v1    # "length":I
    :cond_0
    const-string v3, "https://upload.api.weibo.com/2/short_url/expand.json"
...
.method public locations(Ljava/lang/String;Lcom/weibo/sdk/android/net/RequestListener;)V
    ...
    .line 91
    const-string v1, "https://upload.api.weibo.com/2/short_url/locations.json"
...
.method public referers(Ljava/lang/String;Lcom/weibo/sdk/android/net/RequestListener;)V
    ...
    .line 79
    const-string v1, "https://upload.api.weibo.com/2/short_url/referers.json"
...
.method public shareCounts([Ljava/lang/String;Lcom/weibo/sdk/android/net/RequestListener;)V
    ...
    .end local v1    # "length":I
    :cond_0
    const-string v3, "https://upload.api.weibo.com/2/short_url/share/counts.json"
...
.method public shareStatuses(Ljava/lang/String;JJIILcom/weibo/sdk/android/net/RequestListener;)V
    ...
    .line 129
    const-string v1, "https://upload.api.weibo.com/2/short_url/share/statuses.json"
...
.method public shorten([Ljava/lang/String;Lcom/weibo/sdk/android/net/RequestListener;)V
    ...
    .line 28
    const-string/jumbo v3, "url_long"
    ...
    .end local v1    # "length":I
    :cond_0
    const-string v3, "https://upload.api.weibo.com/2/short_url/shorten.json"

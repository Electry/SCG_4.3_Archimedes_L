.class public Lcom/lenovo/scg/gallery3d/ingest/data/MtpBitmapFetch;
...
.method static constructor <clinit>()V
    ...
    sput v0, Lcom/lenovo/scg/gallery3d/ingest/data/MtpBitmapFetch;->sMaxSize:I
...
.method public static configureForContext(Landroid/content/Context;)V
    ...
    sput v2, Lcom/lenovo/scg/gallery3d/ingest/data/MtpBitmapFetch;->sMaxSize:I

    .line 106
    return-void
.end method

.method public static getFullsize(Landroid/mtp/MtpDevice;Landroid/mtp/MtpObjectInfo;)Lcom/lenovo/scg/gallery3d/ingest/data/BitmapWithMetadata;
    .locals 1
    ...
    .prologue
    .line 67
    sget v0, Lcom/lenovo/scg/gallery3d/ingest/data/MtpBitmapFetch;->sMaxSize:I

    invoke-static {p0, p1, v0}, Lcom/lenovo/scg/gallery3d/ingest/data/MtpBitmapFetch;->getFullsize(Landroid/mtp/MtpDevice;Landroid/mtp/MtpObjectInfo;I)Lcom/lenovo/scg/gallery3d/ingest/data/BitmapWithMetadata;
...
.method public static getFullsize(Landroid/mtp/MtpDevice;Landroid/mtp/MtpObjectInfo;I)Lcom/lenovo/scg/gallery3d/ingest/data/BitmapWithMetadata;
    .locals 11
    .param p0, "device"    # Landroid/mtp/MtpDevice;
    .param p1, "info"    # Landroid/mtp/MtpObjectInfo;
    .param p2, "maxSide"    # I
    ...
    .line 98
    new-instance v7, Lcom/lenovo/scg/gallery3d/ingest/data/BitmapWithMetadata;

    invoke-static {v3}, Lcom/lenovo/scg/camera/Exif;->getOrientation([B)I

    move-result v8

    invoke-direct {v7, v1, v8}, Lcom/lenovo/scg/gallery3d/ingest/data/BitmapWithMetadata;-><init>(Landroid/graphics/Bitmap;I)V
...
.method public static getThumbnail(Landroid/mtp/MtpDevice;Landroid/mtp/MtpObjectInfo;)Landroid/graphics/Bitmap;
    ...
    invoke-virtual {v3, v4, v5}, Lcom/lenovo/scg/photos/data/GalleryBitmapPool;->get(II)Landroid/graphics/Bitmap;

.class public final Lcom/lenovo/scg/gallery3d/util/MotionEventHelper;
...
.method public static transformEvent(Landroid/view/MotionEvent;Landroid/graphics/Matrix;)Landroid/view/MotionEvent;
    ...
    .prologue
    .line 34
    sget-boolean v0, Lcom/lenovo/scg/gallery3d/common/ApiHelper;->HAS_MOTION_EVENT_TRANSFORM:Z

    if-eqz v0, :cond_0

    .line 35
    invoke-static {p0, p1}, Lcom/lenovo/scg/gallery3d/util/MotionEventHelper;->transformEventNew(Landroid/view/MotionEvent;Landroid/graphics/Matrix;)Landroid/view/MotionEvent;
    ...
    :cond_0
    invoke-static {p0, p1}, Lcom/lenovo/scg/gallery3d/util/MotionEventHelper;->transformEventOld(Landroid/view/MotionEvent;Landroid/graphics/Matrix;)Landroid/view/MotionEvent;
...
.method private static transformEventOld(Landroid/view/MotionEvent;Landroid/graphics/Matrix;)Landroid/view/MotionEvent;
    ...
    invoke-static/range {p0 .. p0}, Lcom/lenovo/scg/gallery3d/util/MotionEventHelper;->getPointerIds(Landroid/view/MotionEvent;)[I

    move-result-object v8

    .line 55
    .local v8, "pointerIds":[I
    invoke-static/range {p0 .. p0}, Lcom/lenovo/scg/gallery3d/util/MotionEventHelper;->getPointerCoords(Landroid/view/MotionEvent;)[Landroid/view/MotionEvent$PointerCoords;
    ...
    invoke-static {v0, v1}, Lcom/lenovo/scg/gallery3d/util/MotionEventHelper;->transformAngle(Landroid/graphics/Matrix;F)F

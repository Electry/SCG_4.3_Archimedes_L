.class public Lcom/lenovo/scg/gallery3d/data/MtpClient;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/lenovo/scg/gallery3d/data/MtpClient$Listener;
    }
.end annotation
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v1, p0, Lcom/lenovo/scg/gallery3d/data/MtpClient;->mListeners:Ljava/util/ArrayList;
    ...
    iput-object v1, p0, Lcom/lenovo/scg/gallery3d/data/MtpClient;->mDevices:Ljava/util/HashMap;
    ...
    iput-object v1, p0, Lcom/lenovo/scg/gallery3d/data/MtpClient;->mRequestPermissionDevices:Ljava/util/ArrayList;
    ...
    iput-object v1, p0, Lcom/lenovo/scg/gallery3d/data/MtpClient;->mIgnoredDevices:Ljava/util/ArrayList;

    .line 76
    new-instance v1, Lcom/lenovo/scg/gallery3d/data/MtpClient$1;

    invoke-direct {v1, p0}, Lcom/lenovo/scg/gallery3d/data/MtpClient$1;-><init>(Lcom/lenovo/scg/gallery3d/data/MtpClient;)V

    iput-object v1, p0, Lcom/lenovo/scg/gallery3d/data/MtpClient;->mUsbReceiver:Landroid/content/BroadcastReceiver;

    .line 174
    iput-object p1, p0, Lcom/lenovo/scg/gallery3d/data/MtpClient;->mContext:Landroid/content/Context;
    ...
    iput-object v1, p0, Lcom/lenovo/scg/gallery3d/data/MtpClient;->mUsbManager:Landroid/hardware/usb/UsbManager;

    .line 176
    iget-object v1, p0, Lcom/lenovo/scg/gallery3d/data/MtpClient;->mContext:Landroid/content/Context;
    ...
    iput-object v1, p0, Lcom/lenovo/scg/gallery3d/data/MtpClient;->mPermissionIntent:Landroid/app/PendingIntent;
    ...
    .line 181
    iget-object v1, p0, Lcom/lenovo/scg/gallery3d/data/MtpClient;->mUsbReceiver:Landroid/content/BroadcastReceiver;
...
.method static synthetic access$000(Lcom/lenovo/scg/gallery3d/data/MtpClient;)Ljava/util/HashMap;
    .locals 1
    .param p0, "x0"    # Lcom/lenovo/scg/gallery3d/data/MtpClient;

    .prologue
    .line 48
    iget-object v0, p0, Lcom/lenovo/scg/gallery3d/data/MtpClient;->mDevices:Ljava/util/HashMap;

    return-object v0
.end method

.method static synthetic access$100(Lcom/lenovo/scg/gallery3d/data/MtpClient;Landroid/hardware/usb/UsbDevice;)Landroid/mtp/MtpDevice;
    .locals 1
    .param p0, "x0"    # Lcom/lenovo/scg/gallery3d/data/MtpClient;
    ...
    .prologue
    .line 48
    invoke-direct {p0, p1}, Lcom/lenovo/scg/gallery3d/data/MtpClient;->openDeviceLocked(Landroid/hardware/usb/UsbDevice;)Landroid/mtp/MtpDevice;
...
.method static synthetic access$200(Lcom/lenovo/scg/gallery3d/data/MtpClient;)Ljava/util/ArrayList;
    .locals 1
    .param p0, "x0"    # Lcom/lenovo/scg/gallery3d/data/MtpClient;

    .prologue
    .line 48
    iget-object v0, p0, Lcom/lenovo/scg/gallery3d/data/MtpClient;->mListeners:Ljava/util/ArrayList;

    return-object v0
.end method

.method static synthetic access$300(Lcom/lenovo/scg/gallery3d/data/MtpClient;)Ljava/util/ArrayList;
    .locals 1
    .param p0, "x0"    # Lcom/lenovo/scg/gallery3d/data/MtpClient;

    .prologue
    .line 48
    iget-object v0, p0, Lcom/lenovo/scg/gallery3d/data/MtpClient;->mRequestPermissionDevices:Ljava/util/ArrayList;

    return-object v0
.end method

.method static synthetic access$400(Lcom/lenovo/scg/gallery3d/data/MtpClient;)Ljava/util/ArrayList;
    .locals 1
    .param p0, "x0"    # Lcom/lenovo/scg/gallery3d/data/MtpClient;

    .prologue
    .line 48
    iget-object v0, p0, Lcom/lenovo/scg/gallery3d/data/MtpClient;->mIgnoredDevices:Ljava/util/ArrayList;
...
.method private openDeviceLocked(Landroid/hardware/usb/UsbDevice;)Landroid/mtp/MtpDevice;
    ...
    invoke-static {p1}, Lcom/lenovo/scg/gallery3d/data/MtpClient;->isCamera(Landroid/hardware/usb/UsbDevice;)Z

    move-result v3

    if-eqz v3, :cond_0

    iget-object v3, p0, Lcom/lenovo/scg/gallery3d/data/MtpClient;->mIgnoredDevices:Ljava/util/ArrayList;
    ...
    iget-object v3, p0, Lcom/lenovo/scg/gallery3d/data/MtpClient;->mRequestPermissionDevices:Ljava/util/ArrayList;
    ...
    .line 197
    iget-object v3, p0, Lcom/lenovo/scg/gallery3d/data/MtpClient;->mUsbManager:Landroid/hardware/usb/UsbManager;
    ...
    iget-object v4, p0, Lcom/lenovo/scg/gallery3d/data/MtpClient;->mPermissionIntent:Landroid/app/PendingIntent;
    ...
    .line 205
    iget-object v3, p0, Lcom/lenovo/scg/gallery3d/data/MtpClient;->mDevices:Ljava/util/HashMap;
...
# virtual methods
.method public addListener(Lcom/lenovo/scg/gallery3d/data/MtpClient$Listener;)V
    .locals 2
    .param p1, "listener"    # Lcom/lenovo/scg/gallery3d/data/MtpClient$Listener;

    .prologue
    .line 235
    iget-object v1, p0, Lcom/lenovo/scg/gallery3d/data/MtpClient;->mDevices:Ljava/util/HashMap;
...
.method public close()V
    ...
    .prologue
    .line 224
    iget-object v0, p0, Lcom/lenovo/scg/gallery3d/data/MtpClient;->mContext:Landroid/content/Context;
...
.method public deleteObject(Ljava/lang/String;I)Z
    ...
    .prologue
    .line 356
    invoke-virtual {p0, p1}, Lcom/lenovo/scg/gallery3d/data/MtpClient;->getDevice(Ljava/lang/String;)Landroid/mtp/MtpDevice;
...
.method public getDeviceList()Ljava/util/List;
    ...
    .line 290
    :try_start_0
    iget-object v2, p0, Lcom/lenovo/scg/gallery3d/data/MtpClient;->mUsbManager:Landroid/hardware/usb/UsbManager;
    ...
    iget-object v2, p0, Lcom/lenovo/scg/gallery3d/data/MtpClient;->mDevices:Ljava/util/HashMap;
    ...
    .line 292
    invoke-direct {p0, v1}, Lcom/lenovo/scg/gallery3d/data/MtpClient;->openDeviceLocked(Landroid/hardware/usb/UsbDevice;)Landroid/mtp/MtpDevice;
    ...
    iget-object v4, p0, Lcom/lenovo/scg/gallery3d/data/MtpClient;->mDevices:Ljava/util/HashMap;
...
.method public removeListener(Lcom/lenovo/scg/gallery3d/data/MtpClient$Listener;)V
    .locals 2
    .param p1, "listener"    # Lcom/lenovo/scg/gallery3d/data/MtpClient$Listener;

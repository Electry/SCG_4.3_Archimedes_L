...
.method public static getStData(Landroid/content/Context;Ljava/lang/String;Lcom/lenovo/lsf/account/OldPsAuthenServiceL$OnAuthenListener;ZLandroid/os/Bundle;)V
    ...
    invoke-virtual {v4}, Lcom/lenovo/lsf/account/OldPsAuthenServiceL$1;->start()V
...
.method private static setErrorString(Landroid/content/Context;)V
    ...
    const-string/jumbo v5, "psauthen_error10"
    ...
    const-string/jumbo v5, "psauthen_text20"
    ...
    const-string/jumbo v5, "tgt_error"
...
.method private static showLoginRegisterDialog(Landroid/content/Context;Ljava/lang/String;Lcom/lenovo/lsf/account/OldPsAuthenServiceL$OnAuthenListener;Landroid/os/Bundle;)V
    ...
    invoke-virtual {v3, v6}, Lcom/lenovo/lps/reaper/sdk/AnalyticsTracker;->setUserId(Ljava/lang/String;)V
    ...
    :cond_0
    const-string v3, "auto_onekey_login"
    ...
    .line 228
    const-string v3, "auto_onekey_login_no_ui_sso"

    invoke-virtual {p3, v3, v8}, Landroid/os/Bundle;->getBoolean(Ljava/lang/String;Z)Z

    move-result v3

    sput-boolean v3, Lcom/lenovo/lsf/account/OldPsAuthenServiceL;->isNoUi:Z
    ...
    .line 232
    const-string v3, "auto_onekey_login_handle_by_self"

    invoke-virtual {p3, v3, v8}, Landroid/os/Bundle;->getBoolean(Ljava/lang/String;Z)Z

    move-result v3

    sput-boolean v3, Lcom/lenovo/lsf/account/OldPsAuthenServiceL;->isHandleErrorBySelf:Z
    ...
    .line 235
    const-string v3, "auto_onekey_login_time_out"
    ...
    .end local v4    # "timesOut":J
    :goto_0
    invoke-static {p0, p1, v4, v5, p2}, Lcom/lenovo/lsf/account/OldPsAuthenServiceL;->startPreOneKeyLoginProgress(Landroid/content/Context;Ljava/lang/String;JLcom/lenovo/lsf/account/OldPsAuthenServiceL$OnAuthenListener;)V
    ...
    .end local v4    # "timesOut":J
    :cond_2
    sget-boolean v3, Lcom/lenovo/lsf/account/OldPsAuthenServiceL;->isHandleErrorBySelf:Z
    ...
    const-string/jumbo v7, "sim_error"
    ...
    invoke-interface {p2, v8, v3}, Lcom/lenovo/lsf/account/OldPsAuthenServiceL$OnAuthenListener;->onFinished(ZLjava/lang/String;)V
    ...
    const-class v3, Lcom/lenovo/lsf/account/PsLoginActivity;
...
.method private static startOneKeyLoginProcess(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/lenovo/lsf/account/OldPsAuthenServiceL$OnAuthenListener;)V
    ...
    invoke-virtual {v0}, Lcom/lenovo/lsf/account/OldPsAuthenServiceL$3;->start()V
...
.method private static startPreOneKeyLoginProgress(Landroid/content/Context;Ljava/lang/String;JLcom/lenovo/lsf/account/OldPsAuthenServiceL$OnAuthenListener;)V
    ...
    invoke-virtual {v1, v2, v4, v5}, Lcom/lenovo/lps/reaper/sdk/AnalyticsTracker;->setParam(ILjava/lang/String;Ljava/lang/String;)V
    ...
    const-string v4, "clk_login_auto_onekey"

    const/4 v5, -0x1

    invoke-virtual {v1, v2, v4, p1, v5}, Lcom/lenovo/lps/reaper/sdk/AnalyticsTracker;->trackEvent(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)V

    .line 325
    new-instance v3, Lcom/lenovo/lsf/account/OldPsAuthenServiceL$MyHandler;

    invoke-direct {v3, p0}, Lcom/lenovo/lsf/account/OldPsAuthenServiceL$MyHandler;-><init>(Landroid/content/Context;)V

    .line 326
    .local v3, "myHandler":Lcom/lenovo/lsf/account/OldPsAuthenServiceL$MyHandler;
    invoke-static {p0}, Lcom/lenovo/lsf/account/OldPsAuthenServiceL;->getOnkeyLoginTimes(Landroid/content/Context;)I
    ...
    .line 328
    new-instance v1, Lcom/lenovo/lsf/account/OldPsAuthenServiceL$2;
    ...
    invoke-direct/range {v1 .. v7}, Lcom/lenovo/lsf/account/OldPsAuthenServiceL$2;-><init>(Landroid/content/Context;Lcom/lenovo/lsf/account/OldPsAuthenServiceL$MyHandler;Lcom/lenovo/lsf/account/OldPsAuthenServiceL$OnAuthenListener;Ljava/lang/String;J)V

    invoke-virtual {v1}, Lcom/lenovo/lsf/account/OldPsAuthenServiceL$2;->start()V

...
.method private finishLogin(ZLjava/lang/String;)V
    ...
    invoke-virtual {p0, v1, v0}, Lcom/lenovo/lsf/account/PsLoginActivity;->setResult(ILandroid/content/Intent;)V

    .line 1886
    invoke-virtual {p0}, Lcom/lenovo/lsf/account/PsLoginActivity;->finish()V
...
.method private getCountryCode()Ljava/lang/String;
    ...
    .prologue
    .line 713
    invoke-virtual {p0}, Lcom/lenovo/lsf/account/PsLoginActivity;->getResources()Landroid/content/res/Resources;
...
.method private getOnkeyPre()V
    ...
    invoke-virtual {v0}, Lcom/lenovo/lsf/account/PsLoginActivity$3;->start()V
...
.method private getProtocolUrl()Ljava/lang/String;
    ...
    .line 1425
    :goto_1
    invoke-virtual {p0}, Lcom/lenovo/lsf/account/PsLoginActivity;->getApplicationContext()Landroid/content/Context;
    ...
    const-string/jumbo v3, "wauthen/serviceterms/"
...
.method private getTopHeight()I
    ...
    .prologue
    .line 1769
    invoke-virtual {p0}, Lcom/lenovo/lsf/account/PsLoginActivity;->getWindow()Landroid/view/Window;
...
.method private getValue(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lcom/lenovo/lsf/account/PsLoginActivity;->getContentResolver()Landroid/content/ContentResolver;
...
.method private getVersionName()Ljava/lang/String;
    ...
    .line 1902
    :try_start_0
    invoke-virtual {p0}, Lcom/lenovo/lsf/account/PsLoginActivity;->getPackageManager()Landroid/content/pm/PackageManager;

    move-result-object v2

    .line 1903
    .local v2, "packageManager":Landroid/content/pm/PackageManager;
    invoke-virtual {p0}, Lcom/lenovo/lsf/account/PsLoginActivity;->getPackageName()Ljava/lang/String;
...
.method private initViews()V
    ...
    const-string/jumbo v8, "third_login_layout"
    ...
    const-string/jumbo v8, "regist_scrollview"
    ...
    const-string/jumbo v8, "register_text_login"
    ...
    const-string/jumbo v8, "register_text_protocol"
    ...
    const-string/jumbo v8, "register_string_agree"
    ...
    const-string/jumbo v8, "register_image_frame"
    ...
    const-string/jumbo v8, "register_button_changeanother"
    ...
    const-string/jumbo v8, "register_button_register"
    ...
    const-string/jumbo v8, "register_edit_account"
    ...
    const-string/jumbo v8, "register_edit_setpwd"
    ...
    const-string/jumbo v8, "register_edit_confirmpwd"
    ...
    const-string/jumbo v8, "register_edit_verifycode"
    ...
    const-string/jumbo v8, "register_image_verify"
    ...
    const-string/jumbo v8, "register_text_haveid"
...
.method private refreshVerifyImage()V
    ...
    invoke-virtual {v0}, Lcom/lenovo/lsf/account/PsLoginActivity$9;->start()V
...
.method private registSMSReceiver()V
    ...
    invoke-virtual {p0, v1, v0}, Lcom/lenovo/lsf/account/PsLoginActivity;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;
...
.method private sendMessageDelayed(IJ)V
    ...
    invoke-virtual {v1}, Lcom/lenovo/lsf/account/PsLoginActivity$MyHandler;->obtainMessage()Landroid/os/Message;
    ...
    invoke-virtual {v1, v0, p2, p3}, Lcom/lenovo/lsf/account/PsLoginActivity$MyHandler;->sendMessageDelayed(Landroid/os/Message;J)Z
...
.method public static showDialog(Landroid/content/Context;Landroid/app/ProgressDialog;Ljava/lang/String;)V
    ...
    invoke-virtual {p1, v3}, Landroid/app/ProgressDialog;->setTitle(Ljava/lang/CharSequence;)V
    ...
    const-string/jumbo v4, "progress_dialog_holo"
    ...
    .line 426
    invoke-virtual {p1, v2}, Landroid/app/ProgressDialog;->setContentView(Landroid/view/View;)V
...
.method private startBindingActivity(Ljava/util/HashMap;)V
    ...
    .line 1333
    const-string/jumbo v2, "oauthversion"

    const-string/jumbo v1, "oauthversion"
    ...
    .line 1339
    const-string/jumbo v2, "thirddesc"

    const-string/jumbo v1, "thirddesc"
    ...
    .line 1342
    const-string/jumbo v2, "reveal_ScreenName"

    const-string/jumbo v1, "reveal_ScreenName"
    ...
    .line 1344
    invoke-virtual {p0, v0}, Lcom/lenovo/lsf/account/PsLoginActivity;->startActivity(Landroid/content/Intent;)V
...
.method private startLoginProcess(Z)V
    ...
    invoke-virtual {v2}, Lcom/lenovo/lsf/account/PsLoginActivity$5;->start()V
...
.method private startLoginResendProcess(Ljava/lang/String;)V
    ...
    invoke-virtual {v0}, Lcom/lenovo/lsf/account/PsLoginActivity$7;->start()V
...
.method private startOneKeyRegisterProgress()V
    ...
    invoke-virtual {v0}, Lcom/lenovo/lsf/account/PsLoginActivity$4;->start()V
...
.method private startRegisterProgress()V
    ...
    invoke-virtual {v0}, Lcom/lenovo/lsf/account/PsLoginActivity$6;->start()V
...
.method private startRegisterResendProgress()V
    ...
    invoke-virtual {v0}, Lcom/lenovo/lsf/account/PsLoginActivity$8;->start()V
...
.method private startThirdLogin(Ljava/lang/String;)V
    ...
    const-string/jumbo v8, "wauthen/oauth?"
    ...
    .line 645
    invoke-virtual {p0, v1}, Lcom/lenovo/lsf/account/PsLoginActivity;->startActivity(Landroid/content/Intent;)V
    :try_end_1
    ...
    .line 649
    invoke-virtual {p0, v3}, Lcom/lenovo/lsf/account/PsLoginActivity;->startActivity(Landroid/content/Intent;)V
...
.method private startThirdLoginProcess(Ljava/util/HashMap;)V
    ...
    invoke-virtual {v0, v1}, Lcom/lenovo/lsf/account/PsLoginActivity$2;->execute([Ljava/lang/Object;)Landroid/os/AsyncTask;
...
.method private unRegistSMSReceiver()V
    ...
    invoke-virtual {p0, v0}, Lcom/lenovo/lsf/account/PsLoginActivity;->unregisterReceiver(Landroid/content/BroadcastReceiver;)V
...
.method public onClick(Landroid/view/View;)V
    ...
    const-string/jumbo v6, "username_not_null"
    ...
    const-string/jumbo v6, "password_not_null"
    ...
    const-string/jumbo v6, "senced_password_not_null"
    ...
    .line 581
    invoke-virtual {p0, v5}, Lcom/lenovo/lsf/account/PsLoginActivity;->setProgressBarIndeterminateVisibility(Z)V
    ...
    const-string/jumbo v7, "onekey_airplanemode"
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    .line 206
    invoke-virtual {p0}, Lcom/lenovo/lsf/account/PsLoginActivity;->getIntent()Landroid/content/Intent;
    ...
    invoke-virtual {v6, v7}, Lcom/lenovo/lsf/account/PsLoginActivity$MyHandler;->sendEmptyMessage(I)Z

    .line 228
    :cond_3
    invoke-virtual {p0}, Lcom/lenovo/lsf/account/PsLoginActivity;->getLayoutInflater()Landroid/view/LayoutInflater;
    ...
    const-string/jumbo v7, "uilayout"
    ...
    invoke-virtual {v2, v6}, Lcom/lenovo/lsf/account/view/KeyboardLayout;->findViewById(I)Landroid/view/View;
    ...
    .line 257
    invoke-virtual {p0, v9}, Lcom/lenovo/lsf/account/PsLoginActivity;->requestWindowFeature(I)Z

    .line 258
    invoke-virtual {p0, v2}, Lcom/lenovo/lsf/account/PsLoginActivity;->setContentView(Landroid/view/View;)V
...
.method protected onCreateDialog(I)Landroid/app/Dialog;
    ...
    invoke-virtual {p0, v1}, Lcom/lenovo/lsf/account/PsLoginActivity;->getString(I)Ljava/lang/String;
...
.method protected onResume()V
    ...
    const-string/jumbo v8, "register_time_out"

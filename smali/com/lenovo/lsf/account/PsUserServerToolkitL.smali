...
.method public static getStData(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    .prologue
    .line 252
    const-string v14, "LenovoUser"

    const-string v15, "IsLogon"

    move-object/from16 v0, p0

    invoke-static {v0, v14, v15}, Lcom/lenovo/lsf/account/PsPushUserData;->getValue(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v4

    .line 254
    .local v4, "isLogon":Ljava/lang/String;
    if-eqz v4, :cond_0
    ...
    sget-boolean v14, Lcom/lenovo/lsf/account/PsUserServerToolkitL;->isLogoutting:Z

    if-eqz v14, :cond_2

    .line 255
    :cond_0
    const-string v6, "USS-0202"
    ...
    .line 260
    .local v6, "oldst":Ljava/lang/String;
    if-eqz v6, :cond_3
    ...
    .line 263
    .local v8, "soldtime":Ljava/lang/String;
    const-string v14, "LenovoUser"
    ...
    .line 265
    .local v9, "soldttl":Ljava/lang/String;
    if-eqz v8, :cond_3
    ...
    .line 269
    .local v5, "newtime":Landroid/text/format/Time;
    ...
    .line 273
    const-string v14, "RK_PUSHSDK"

    const-string v15, "getStData(): cache stdata is valid"
    ...
    .end local v5    # "newtime":Landroid/text/format/Time;
    .end local v8    # "soldtime":Ljava/lang/String;
    .end local v9    # "soldttl":Ljava/lang/String;
    .end local v12    # "ttltime":J
    :cond_3
    ...
    sget-boolean v14, Lcom/lenovo/lsf/account/PsUserServerToolkitL;->isRenewTgting:Z
    ...
    sput-boolean v14, Lcom/lenovo/lsf/account/PsUserServerToolkitL;->isRenewTgting:Z
    ...
    const-string v15, "getStData(): cache stdata is invalid"
    ...
    const-string v15, "getStData(): TGT invalid"
    ...
    const-string v16, "SPECIAL_TOKEN"

    const-string v17, "QJFOKY5F65WI"

    invoke-virtual/range {v14 .. v17}, Lcom/lenovo/lps/reaper/sdk/AnalyticsTracker;->setParam(ILjava/lang/String;Ljava/lang/String;)V
    ...
    const-string v15, "lenovoid_logout"

    const-string/jumbo v16, "tgt_invalid_logout"

    const/16 v17, 0x0

    const/16 v18, 0x0

    invoke-virtual/range {v14 .. v18}, Lcom/lenovo/lps/reaper/sdk/AnalyticsTracker;->trackEvent(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)V
    ...
    invoke-static {v0, v14, v15, v1}, Lcom/lenovo/lsf/account/PsPushUserData;->setValue(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Z
...
.method private static isTgtValid(Landroid/content/Context;)Z
    ...
    const-string v12, "TgtData"

    move-object/from16 v0, p0

    invoke-static {v0, v9, v12}, Lcom/lenovo/lsf/account/PsPushUserData;->getValue(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v6

    .line 182
    .local v6, "oldtgt":Ljava/lang/String;
    if-eqz v6, :cond_2
    ...
    const-string/jumbo v12, "regetTgtData(): cache tgtdata is valid"
    ...
    .restart local v5    # "newtime":Landroid/text/format/Time;
    .restart local v7    # "soldtime":Ljava/lang/String;
    .restart local v8    # "soldttl":Ljava/lang/String;
    .restart local v10    # "ttltime":J
    :cond_1
    const/4 v9, 0x0
...
.method public static newStData(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v5, "newStData(): "
    ...
    const-string/jumbo v6, "tgt_invalid_logout"
...
.method private static renewTgtData(Landroid/content/Context;)Ljava/lang/String;
    ...
    const-string/jumbo v5, "regetTgtData(): cache tgtdata is invalid"

...
.method private readResponse(Lorg/apache/http/HttpResponse;Lcom/lenovo/leos/cloud/lcp/common/ProgressListener;Lcom/lenovo/leos/cloud/lcp/file/impl/simple/BatchResult$BatchDownloadVisitor;)V
    ...
    invoke-static {v12, v3, v4}, Lcom/lenovo/leos/cloud/lcp/common/util/IOUtil;->readBytes(Ljava/io/InputStream;IZ)[B
    ...
    invoke-direct {v3, v2}, Lcom/lenovo/leos/cloud/lcp/common/exception/ServerRuntimeException;-><init>(Ljava/lang/Exception;)V
...
.method private sendOneSegement(Lcom/lenovo/leos/cloud/lcp/file/pilot2/CosObject;Lcom/lenovo/leos/cloud/lcp/file/pilot2/pipe/InputPipe;IJJZ)V
    ...
    .line 199
    .local v12, "writeObjectURIRoller":Lcom/lenovo/leos/cloud/lcp/common/httpclient/URIRoller;
    iget-object v4, p0, Lcom/lenovo/leos/cloud/lcp/file/pilot2/CosOperator;->connector:Lcom/lenovo/leos/cloud/lcp/file/pilot2/Connector;

    invoke-virtual {v4}, Lcom/lenovo/leos/cloud/lcp/file/pilot2/Connector;->getSessionId()Ljava/lang/String;

    move-result-object v5

    .line 200
    .local v5, "sessionId":Ljava/lang/String;
    new-instance v3, Lcom/lenovo/leos/cloud/lcp/file/pilot2/CosOperator$WriteObjectRequestIntercepter;
    ...
    invoke-direct/range {v3 .. v11}, Lcom/lenovo/leos/cloud/lcp/file/pilot2/CosOperator$WriteObjectRequestIntercepter;-><init>(Lcom/lenovo/leos/cloud/lcp/file/pilot2/Connector;Ljava/lang/String;JJJ)V

    .line 201
    .local v3, "intercepter":Lcom/lenovo/leos/cloud/lcp/file/pilot2/CosOperator$WriteObjectRequestIntercepter;
    move/from16 v0, p8

    invoke-virtual {v3, v0}, Lcom/lenovo/leos/cloud/lcp/file/pilot2/CosOperator$WriteObjectRequestIntercepter;->setCommit(Z)V

    .line 202
    invoke-interface/range {p2 .. p2}, Lcom/lenovo/leos/cloud/lcp/file/pilot2/pipe/InputPipe;->contentType()Ljava/lang/String;

    move-result-object v4

    invoke-virtual {v3, v4}, Lcom/lenovo/leos/cloud/lcp/file/pilot2/CosOperator$WriteObjectRequestIntercepter;->setContentType(Ljava/lang/String;)V

    .line 204
    iget-object v4, p0, Lcom/lenovo/leos/cloud/lcp/file/pilot2/CosOperator;->httpMatchine:Lcom/lenovo/leos/cloud/lcp/common/httpclient/HttpRequestMachine;

    invoke-virtual {v4, v3}, Lcom/lenovo/leos/cloud/lcp/common/httpclient/HttpRequestMachine;->setRequestIntercepter(Lcom/lenovo/leos/cloud/lcp/common/httpclient/HttpRequestMachine$RequestIntercepter;)V

    .line 205
    iget-object v4, p0, Lcom/lenovo/leos/cloud/lcp/file/pilot2/CosOperator;->httpMatchine:Lcom/lenovo/leos/cloud/lcp/common/httpclient/HttpRequestMachine;

    new-instance v6, Lcom/lenovo/leos/cloud/lcp/file/pilot2/pipe/InputPipeEntity;
    ...
    invoke-direct/range {v6 .. v11}, Lcom/lenovo/leos/cloud/lcp/file/pilot2/pipe/InputPipeEntity;-><init>(Lcom/lenovo/leos/cloud/lcp/file/pilot2/pipe/InputPipe;JJ)V

    invoke-virtual {v4, v12, v6}, Lcom/lenovo/leos/cloud/lcp/common/httpclient/HttpRequestMachine;->putForText(Lcom/lenovo/leos/cloud/lcp/common/httpclient/URIRoller;Lorg/apache/http/HttpEntity;)Ljava/lang/String;
    ...
    .line 207
    invoke-direct {p0, v2}, Lcom/lenovo/leos/cloud/lcp/file/pilot2/CosOperator;->verifyUploadSegemetResponse(Ljava/lang/String;)V
...
.method private updateCosObjectState(Ljava/lang/String;Ljava/util/List;)V
    ...
    .line 259
    .local v1, "json":Lorg/json/JSONObject;
    const-string/jumbo v3, "success_keys"
...
.method public writeObject(Lcom/lenovo/leos/cloud/lcp/file/pilot2/CosObject;Lcom/lenovo/leos/cloud/lcp/file/pilot2/pipe/InputPipe;)V
    ...
    .prologue
    .line 131
    invoke-interface/range {p2 .. p2}, Lcom/lenovo/leos/cloud/lcp/file/pilot2/pipe/InputPipe;->contentLength()J

    move-result-wide v12

    .line 132
    .local v12, "totalLength":J
    const-wide/16 v0, 0x0
    ...
    invoke-direct {v0, v7, v1}, Lcom/lenovo/leos/cloud/lcp/common/exception/ServerRuntimeException;-><init>(Ljava/lang/Exception;I)V

...
.method private buildResultObjects(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    invoke-direct {v4, v5, v6, v8, v9}, Lcom/lenovo/leos/cloud/lcp/file/impl/simple/BatchResult$ResultObject;-><init>(Ljava/lang/String;Ljava/lang/String;J)V
...
.method private preparePilot()V
    ...
    const-string/jumbo v2, "\u83b7\u53d6\u7684Lpsust\u4e3anull, \u8bf7\u68c0\u67e5\u662f\u5426\u767b\u5f55\u6216LenovoId\u7684Bug"
...
.method public uploadToPilot(Ljava/util/List;Lcom/lenovo/leos/cloud/lcp/common/ProgressListener;)Ljava/util/List;
    ...
    .local p0, "this":Lcom/lenovo/leos/cloud/lcp/file/impl/PilotSupport;, "Lcom/lenovo/leos/cloud/lcp/file/impl/PilotSupport<TT;>;"
    .local p1, "entities":Ljava/util/List;, "Ljava/util/List<TT;>;"
    invoke-direct/range {p0 .. p0}, Lcom/lenovo/leos/cloud/lcp/file/impl/PilotSupport;->preparePilot()V
    ...
    .line 134
    .local v8, "resultList":Ljava/util/List;, "Ljava/util/List<Lcom/lenovo/leos/cloud/lcp/file/impl/simple/BatchResult$ResultObject;>;"
    new-instance v3, Ljava/util/ArrayList;

    invoke-direct {v3}, Ljava/util/ArrayList;-><init>()V

    .line 135
    .local v3, "cosList":Ljava/util/List;, "Ljava/util/List<Lcom/lenovo/leos/cloud/lcp/file/pilot2/CosObject;>;"
    new-instance v7, Ljava/util/ArrayList;

    invoke-direct {v7}, Ljava/util/ArrayList;-><init>()V

    .line 137
    .local v7, "pipeList":Ljava/util/List;, "Ljava/util/List<Lcom/lenovo/leos/cloud/lcp/file/pilot2/pipe/InputPipe;>;"
    if-eqz p1, :cond_0
    ...
    .line 174
    .end local v8    # "resultList":Ljava/util/List;, "Ljava/util/List<Lcom/lenovo/leos/cloud/lcp/file/impl/simple/BatchResult$ResultObject;>;"
    .local v9, "resultList":Ljava/lang/Object;, "Ljava/util/List<Lcom/lenovo/leos/cloud/lcp/file/impl/simple/BatchResult$ResultObject;>;"
    :goto_0
    return-object v9

    .line 141
    .end local v9    # "resultList":Ljava/lang/Object;, "Ljava/util/List<Lcom/lenovo/leos/cloud/lcp/file/impl/simple/BatchResult$ResultObject;>;"
    .restart local v8    # "resultList":Ljava/util/List;, "Ljava/util/List<Lcom/lenovo/leos/cloud/lcp/file/impl/simple/BatchResult$ResultObject;>;"
    :cond_1
    ...
    .line 146
    new-instance v2, Lcom/lenovo/leos/cloud/lcp/file/impl/PilotSupport$BatchUploadProgressListener;

    move-object/from16 v0, p2

    invoke-direct {v2, v10, v11, v0}, Lcom/lenovo/leos/cloud/lcp/file/impl/PilotSupport$BatchUploadProgressListener;-><init>(JLcom/lenovo/leos/cloud/lcp/common/ProgressListener;)V

    .line 147
    .local v2, "batchUploadProgressListener":Lcom/lenovo/leos/cloud/lcp/file/impl/PilotSupport$BatchUploadProgressListener;, "Lcom/lenovo/leos/cloud/lcp/file/impl/PilotSupport$BatchUploadProgressListener;"
    invoke-interface/range {p1 .. p1}, Ljava/util/List;->iterator()Ljava/util/Iterator;
    ...
    iget-object v12, v0, Lcom/lenovo/leos/cloud/lcp/file/impl/PilotSupport;->pilotApi:Lcom/lenovo/leos/cloud/lcp/file/pilot2/PilotAPI;

    invoke-virtual {v12, v7}, Lcom/lenovo/leos/cloud/lcp/file/pilot2/PilotAPI;->batchUpload(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-direct {v0, v1, v3}, Lcom/lenovo/leos/cloud/lcp/file/impl/PilotSupport;->buildResultObjects(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    .line 174
    .restart local v9    # "resultList":Ljava/lang/Object;, "Ljava/util/List<Lcom/lenovo/leos/cloud/lcp/file/impl/simple/BatchResult$ResultObject;>;"
    goto :goto_0

    .line 142
    .end local v2    # "batchUploadProgressListener":Lcom/lenovo/leos/cloud/lcp/file/impl/PilotSupport$BatchUploadProgressListener;, "Lcom/lenovo/leos/cloud/lcp/file/impl/PilotSupport$BatchUploadProgressListener;"
    .end local v9    # "resultList":Ljava/lang/Object;, "Ljava/util/List<Lcom/lenovo/leos/cloud/lcp/file/impl/simple/BatchResult$ResultObject;>;"
    :cond_2
    ...
    check-cast v5, Lcom/lenovo/leos/cloud/lcp/file/entity/Entity;

    .line 143
    .local v5, "entity":Lcom/lenovo/leos/cloud/lcp/file/entity/Entity;, "TT;"
    invoke-interface {v5}, Lcom/lenovo/leos/cloud/lcp/file/entity/Entity;->length()J
    ...
    .line 147
    .end local v5    # "entity":Lcom/lenovo/leos/cloud/lcp/file/entity/Entity;, "TT;"
    .restart local v2    # "batchUploadProgressListener":Lcom/lenovo/leos/cloud/lcp/file/impl/PilotSupport$BatchUploadProgressListener;, "Lcom/lenovo/leos/cloud/lcp/file/impl/PilotSupport$BatchUploadProgressListener;"
    :cond_3
    invoke-interface {v12}, Ljava/util/Iterator;->next()Ljava/lang/Object;
    ...
    .line 148
    .restart local v5    # "entity":Lcom/lenovo/leos/cloud/lcp/file/entity/Entity;, "TT;"
    new-instance v6, Lcom/lenovo/leos/cloud/lcp/file/entity/EntityInputPipe;

    invoke-direct {v6, v5}, Lcom/lenovo/leos/cloud/lcp/file/entity/EntityInputPipe;-><init>(Lcom/lenovo/leos/cloud/lcp/file/entity/Entity;)V

    .line 149
    .local v6, "inputPipe":Lcom/lenovo/leos/cloud/lcp/file/entity/EntityInputPipe;
    invoke-virtual {v6, v2}, Lcom/lenovo/leos/cloud/lcp/file/entity/EntityInputPipe;->setProgressListener(Lcom/lenovo/leos/cloud/lcp/common/ProgressListener;)V
    ...
    .line 170
    .end local v5    # "entity":Lcom/lenovo/leos/cloud/lcp/file/entity/Entity;, "TT;"
    .end local v6    # "inputPipe":Lcom/lenovo/leos/cloud/lcp/file/entity/EntityInputPipe;
    :catch_0
    move-exception v4

    .line 171
    .local v4, "e":Ljava/lang/InterruptedException;
    const-string v12, "AppConfFileService"

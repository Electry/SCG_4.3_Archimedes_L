...
.method private doRestoreCalllog(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v1}, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/sdcard/task/CalllogSDcardRetoreTask;->setProgressStep(I)V
...
.method private getCalllogPackageFileReader()Lcom/lenovo/leos/cloud/lcp/sync/modules/common/sdcard/io/PackageFileReader;
    ...
    iget-object v1, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/sdcard/task/CalllogSDcardRetoreTask;->problemResolver:Lcom/lenovo/leos/cloud/lcp/common/ProblemResolver;
...
.method private save(Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/protocol/CalllogRestoreResponse;)V
    ...
    :try_start_0
    invoke-virtual {p0}, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/sdcard/task/CalllogSDcardRetoreTask;->isCancelled()Z
    ...
    iput v8, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/sdcard/task/CalllogSDcardRetoreTask;->result:I
    ...
    .line 105
    :cond_3
    iget-object v6, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/sdcard/task/CalllogSDcardRetoreTask;->uid2id:Ljava/util/Map;
    ...
    .line 106
    iget-object v6, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/sdcard/task/CalllogSDcardRetoreTask;->calllogDao:Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/dao/CalllogDao;

    iget-object v7, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/sdcard/task/CalllogSDcardRetoreTask;->mContext:Landroid/content/Context;
    ...
    iput v6, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/sdcard/task/CalllogSDcardRetoreTask;->result:I
...
.method private traverseExistCalllog()V
    ...
    .prologue
    .line 69
    iget-object v0, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/sdcard/task/CalllogSDcardRetoreTask;->calllogDao:Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/dao/CalllogDao;

    iget-object v1, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/sdcard/task/CalllogSDcardRetoreTask;->mContext:Landroid/content/Context;
...
.method protected beforeTask()V
    ...
    .line 150
    iget-object v0, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/sdcard/task/CalllogSDcardRetoreTask;->problemResolver:Lcom/lenovo/leos/cloud/lcp/common/ProblemResolver;
    ...
    .line 153
    :cond_0
    iget-object v0, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/sdcard/task/CalllogSDcardRetoreTask;->mContext:Landroid/content/Context;
...
.method protected notifyStepProgress(F)V
    ...
    .line 166
    iget v0, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/sdcard/task/CalllogSDcardRetoreTask;->progressStep:I
    ...
    invoke-virtual {p0, v0}, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/sdcard/task/CalllogSDcardRetoreTask;->notifyProgress(F)V
...
.method protected startTask()V
    ...
    iput-wide v0, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/sdcard/task/CalllogSDcardRetoreTask;->start:J

    .line 48
    invoke-virtual {p0, v2}, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/sdcard/task/CalllogSDcardRetoreTask;->setProgressStep(I)V

    .line 50
    const/4 v0, 0x1

    :try_start_0
    invoke-virtual {p0, v0}, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/sdcard/task/CalllogSDcardRetoreTask;->setProgressStep(I)V
    ...
    iget-wide v2, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/sdcard/task/CalllogSDcardRetoreTask;->start:J

    sub-long/2addr v0, v2

    iput-wide v0, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/sdcard/task/CalllogSDcardRetoreTask;->cost:J

    .line 58
    invoke-virtual {p0, v6}, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/sdcard/task/CalllogSDcardRetoreTask;->setProgressStep(I)V

    .line 60
    const-string v2, "LCPCalllog"

    const-string v3, "SDCARD_CALLLOG_RESTORE"
    ...
    .line 61
    iget v5, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/sdcard/task/CalllogSDcardRetoreTask;->result:I

    iget-wide v6, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/sdcard/task/CalllogSDcardRetoreTask;->cost:J

    const-string v8, "1"

    iget v0, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/sdcard/task/CalllogSDcardRetoreTask;->countOfAdd:I

    iget v1, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/sdcard/task/CalllogSDcardRetoreTask;->countOfUpdate:I
    ...
    .line 60
    invoke-virtual/range {v1 .. v9}, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/sdcard/task/CalllogSDcardRetoreTask;->reaperRecord(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;IJLjava/lang/String;I)V
    ...
    iget-wide v4, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/sdcard/task/CalllogSDcardRetoreTask;->start:J

    sub-long/2addr v2, v4

    iput-wide v2, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/sdcard/task/CalllogSDcardRetoreTask;->cost:J
    ...
    iget v1, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/sdcard/task/CalllogSDcardRetoreTask;->countOfAdd:I

    iget v9, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/sdcard/task/CalllogSDcardRetoreTask;->countOfUpdate:I

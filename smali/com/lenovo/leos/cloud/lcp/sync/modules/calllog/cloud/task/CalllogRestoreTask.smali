...
.method private buildRestoreRequest(Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/cloud/protocol/CalllogChecksumResponse;)Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/cloud/protocol/CalllogRestoreRequest;
    ...
    .prologue
    .line 96
    iget-object v2, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/cloud/task/CalllogRestoreTask;->mContext:Landroid/content/Context;
    ...
    invoke-virtual {p0, v2}, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/cloud/task/CalllogRestoreTask;->notifyProgress(F)V
...
.method private buildSmsRestoreRequest(Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/cloud/protocol/CalllogRestoreRequest;Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/cloud/protocol/CalllogChecksumResponse;)V
    ...
    .prologue
    .line 156
    invoke-virtual {p0}, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/cloud/task/CalllogRestoreTask;->isCancelled()Z
...
.method private doRestoreRequest(Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/cloud/protocol/CalllogChecksumResponse;)Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/protocol/CalllogRestoreResponse;
    ...
    .line 108
    iput v9, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/cloud/task/CalllogRestoreTask;->result:I
    ...
    .line 114
    invoke-virtual {p0, v8}, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/cloud/task/CalllogRestoreTask;->notifyProgress(F)V
    ...
    iget-object v6, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/cloud/task/CalllogRestoreTask;->mContext:Landroid/content/Context;
    ...
    const-string/jumbo v7, "sms.cloud.lps.lenovo.com"
    ...
    invoke-virtual {p0, v5}, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/cloud/task/CalllogRestoreTask;->setProgressStep(I)V
    ...
    invoke-virtual {p0, v4, v5, v6}, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/cloud/task/CalllogRestoreTask;->postForText(Lcom/lenovo/leos/cloud/lcp/common/httpclient/URIRoller;[BZ)Ljava/lang/String;
...
.method private mockEncrpyt()V
    ...
    invoke-virtual {p0, v1}, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/cloud/task/CalllogRestoreTask;->setProgressStep(I)V
...
.method private save(Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/protocol/CalllogRestoreResponse;)V
    ...
    .line 54
    .local v4, "total":I
    iput v6, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/cloud/task/CalllogRestoreTask;->countOfAdd:I

    .line 55
    iput v6, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/cloud/task/CalllogRestoreTask;->countOfUpdate:I
    ...
    invoke-virtual {p0, v6}, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/cloud/task/CalllogRestoreTask;->notifyProgress(F)V

    .line 66
    iget-object v6, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/cloud/task/CalllogRestoreTask;->uid2id:Ljava/util/Map;
    ...
    .line 67
    iget-object v6, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/cloud/task/CalllogRestoreTask;->calllogDao:Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/dao/CalllogDao;

    iget-object v8, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/cloud/task/CalllogRestoreTask;->mContext:Landroid/content/Context;
    ...
    .line 74
    iget v6, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/cloud/task/CalllogRestoreTask;->countOfAdd:I
...
.method public getParams()Landroid/os/Bundle;
    ...
    iget v2, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/cloud/task/CalllogRestoreTask;->countOfAdd:I
    ...
    iget v2, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/cloud/task/CalllogRestoreTask;->countOfUpdate:I
...
.method protected onStartCalllogTask(Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/cloud/protocol/CalllogChecksumResponse;)V
    ...
    .line 35
    .local v0, "restoreResponse":Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/protocol/CalllogRestoreResponse;
    if-nez v0, :cond_0
    ...
    .line 37
    :cond_0
    invoke-virtual {v0}, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/protocol/CalllogRestoreResponse;->getResult()I
    ...
    iput v1, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/cloud/task/CalllogRestoreTask;->result:I

    .line 40
    :cond_1
    iget v1, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/cloud/task/CalllogRestoreTask;->result:I
    ...
    .line 42
    invoke-direct {p0, v0}, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/cloud/task/CalllogRestoreTask;->save(Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/protocol/CalllogRestoreResponse;)V
    ...
    iget-wide v4, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/cloud/task/CalllogRestoreTask;->start:J

    sub-long/2addr v2, v4

    iput-wide v2, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/cloud/task/CalllogRestoreTask;->cost:J
    ...
    iget-object v1, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/cloud/task/CalllogRestoreTask;->mContext:Landroid/content/Context;
    ...
    .line 46
    iget v5, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/cloud/task/CalllogRestoreTask;->result:I

    iget-wide v6, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/cloud/task/CalllogRestoreTask;->cost:J

    const-string v8, "1"

    iget v1, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/cloud/task/CalllogRestoreTask;->countOfAdd:I

    iget v9, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/cloud/task/CalllogRestoreTask;->countOfUpdate:I
    ...
    .line 45
    invoke-virtual/range {v1 .. v9}, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/cloud/task/CalllogRestoreTask;->reaperRecord(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;IJLjava/lang/String;I)V

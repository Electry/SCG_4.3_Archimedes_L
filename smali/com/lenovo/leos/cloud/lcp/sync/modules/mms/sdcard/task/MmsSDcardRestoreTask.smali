...
.method private existAndUpdate(Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/dao/vo/RequestMmsEntity;)Z
    ...
    :try_start_0
    iget-object v0, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/sdcard/task/MmsSDcardRestoreTask;->mmsDao:Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/dao/MmsDao;

    iget-object v1, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/sdcard/task/MmsSDcardRestoreTask;->mContext:Landroid/content/Context;
    ...
    .line 157
    iget v0, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/sdcard/task/MmsSDcardRestoreTask;->countOfUpdate:I

    add-int/lit8 v0, v0, 0x1

    iput v0, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/sdcard/task/MmsSDcardRestoreTask;->countOfUpdate:I
...
.method private getPackageReader()Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/sdcard/io/MmsPackageFileReader;
    ...
    iget-object v1, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/sdcard/task/MmsSDcardRestoreTask;->problemResolver:Lcom/lenovo/leos/cloud/lcp/common/ProblemResolver;
    ...
    invoke-virtual {v1}, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/sdcard/io/MmsPackageFileReader;->existsFile()Z
...
.method private importMMSFromJson()V
    ...
    iget-object v4, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/sdcard/task/MmsSDcardRestoreTask;->mContext:Landroid/content/Context;
...
.method private save(Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/dao/vo/RequestMmsEntity;)V
    ...
    iget-wide v8, p1, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/dao/vo/RequestMmsEntity;->date:J
    ...
    .line 127
    iget-object v6, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/sdcard/task/MmsSDcardRestoreTask;->mmsDao:Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/dao/MmsDao;

    iget-object v7, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/sdcard/task/MmsSDcardRestoreTask;->mContext:Landroid/content/Context;
    ...
    .line 128
    iget v6, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/sdcard/task/MmsSDcardRestoreTask;->countOfAdd:I

    add-int/lit8 v6, v6, 0x1

    iput v6, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/sdcard/task/MmsSDcardRestoreTask;->countOfAdd:I

    .line 129
    invoke-virtual {p0}, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/sdcard/task/MmsSDcardRestoreTask;->isCancelled()Z
...
.method private startSDcardRestore()V
    ...
    invoke-virtual {p0, v0}, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/sdcard/task/MmsSDcardRestoreTask;->setProgressStep(I)V

    .line 85
    iget-object v0, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/sdcard/task/MmsSDcardRestoreTask;->mmsDao:Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/dao/MmsDao;

    iget-object v1, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/sdcard/task/MmsSDcardRestoreTask;->context:Landroid/content/Context;
...
.method protected addOtherFinishParam(Landroid/os/Bundle;)V
    ...
    iget v1, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/sdcard/task/MmsSDcardRestoreTask;->countOfAdd:I
    ...
    iget v1, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/sdcard/task/MmsSDcardRestoreTask;->countOfUpdate:I
...
.method protected beforeTask()V
    ...
    .line 168
    iget-object v0, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/sdcard/task/MmsSDcardRestoreTask;->problemResolver:Lcom/lenovo/leos/cloud/lcp/common/ProblemResolver;
    ...
    .line 171
    :cond_0
    iget-object v0, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/sdcard/task/MmsSDcardRestoreTask;->mContext:Landroid/content/Context;
...
.method public getParams()Landroid/os/Bundle;
    ...
    invoke-virtual {p0}, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/sdcard/task/MmsSDcardRestoreTask;->getProgressStep()I
    ...
    iget v2, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/sdcard/task/MmsSDcardRestoreTask;->countOfAdd:I
    ...
    iget v2, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/sdcard/task/MmsSDcardRestoreTask;->countOfUpdate:I
    ...
    iget v2, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/sdcard/task/MmsSDcardRestoreTask;->result:I
...
.method protected notifyStepProgress(F)V
    ...
    .prologue
    .line 183
    iget v0, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/sdcard/task/MmsSDcardRestoreTask;->progressStep:I
    ...
    invoke-virtual {p0, v0}, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/sdcard/task/MmsSDcardRestoreTask;->notifyProgress(F)V
...
.method public startTask()V
    ...
    iput-wide v2, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/sdcard/task/MmsSDcardRestoreTask;->startTime:J

    .line 49
    iget-object v2, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/sdcard/task/MmsSDcardRestoreTask;->context:Landroid/content/Context;
    ...
    :try_start_0
    invoke-virtual {p0, v2}, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/sdcard/task/MmsSDcardRestoreTask;->setProgressStep(I)V
    ...
    iget-object v3, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/sdcard/task/MmsSDcardRestoreTask;->mContext:Landroid/content/Context;
    ...
    iget-wide v4, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/sdcard/task/MmsSDcardRestoreTask;->start:J

    sub-long/2addr v2, v4

    iput-wide v2, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/sdcard/task/MmsSDcardRestoreTask;->cost:J

    .line 66
    const-string v2, "LCPMms"

    const-string v3, "SDCARD_MMS_RESTORE"
    ...
    .line 67
    iget v5, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/sdcard/task/MmsSDcardRestoreTask;->result:I

    iget-wide v6, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/sdcard/task/MmsSDcardRestoreTask;->cost:J

    const-string v8, "1"

    iget v1, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/sdcard/task/MmsSDcardRestoreTask;->countOfAdd:I

    iget v9, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/sdcard/task/MmsSDcardRestoreTask;->countOfUpdate:I
    ...
    .line 66
    invoke-virtual/range {v1 .. v9}, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/sdcard/task/MmsSDcardRestoreTask;->reaperRecord(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;IJLjava/lang/String;I)V
    ...
    :try_start_2
    const-string v2, "MmsSDcardRestoreTask"

    const-string v3, "MmsSDcardRestoreTask IOException"
    ...
    :goto_1
    iput v1, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/sdcard/task/MmsSDcardRestoreTask;->result:I
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0

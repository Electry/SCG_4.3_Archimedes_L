...
.method private appLinkExecute(Lcom/lenovo/leos/cloud/lcp/sync/modules/app/model/LocalAppInfo;)I
    ...
    .line 155
    const-string/jumbo v1, "v3/applink"

    .line 156
    .local v1, "bckupUrl":Ljava/lang/String;
    iget-object v7, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/app/cloud/task/backup/ParentBackupTask;->mContext:Landroid/content/Context;
    ...
    .line 157
    invoke-virtual {p0, v6, v7, v8}, Lcom/lenovo/leos/cloud/lcp/sync/modules/app/cloud/task/backup/ParentBackupTask;->postForText(Lcom/lenovo/leos/cloud/lcp/common/httpclient/URIRoller;[BZ)Ljava/lang/String;
...
.method private appUploadExecute(Lcom/lenovo/leos/cloud/lcp/sync/modules/app/model/LocalAppInfo;)I
    ...
    const-string/jumbo v3, "v3/appupload"
    ...
    .line 93
    iget-object v3, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/app/cloud/task/backup/ParentBackupTask;->mContext:Landroid/content/Context;

    invoke-virtual {v13}, Ljava/lang/StringBuffer;->toString()Ljava/lang/String;

    move-result-object v4

    invoke-static {v3, v4}, Lcom/lenovo/leos/cloud/lcp/sync/modules/app/util/AppUtil;->getAppURIRoller(Landroid/content/Context;Ljava/lang/String;)Lcom/lenovo/leos/cloud/lcp/common/httpclient/URIRoller;
    ...
    iput-object v3, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/app/cloud/task/backup/ParentBackupTask;->headers:Ljava/util/Map;
    ...
    .line 101
    invoke-direct {v9, v3, v4, v0}, Lorg/apache/http/entity/mime/MultipartEntity;-><init>(Lorg/apache/http/entity/mime/HttpMultipartMode;Ljava/lang/String;Ljava/nio/charset/Charset;)V

    .line 104
    .local v9, "entity":Lorg/apache/http/entity/mime/MultipartEntity;
    new-instance v1, Lcom/lenovo/leos/cloud/lcp/sync/modules/app/util/FileBodyOffset;
    ...
    invoke-direct/range {v1 .. v7}, Lcom/lenovo/leos/cloud/lcp/sync/modules/app/util/FileBodyOffset;-><init>(Ljava/io/File;Ljava/lang/String;JJ)V

    .line 105
    .local v1, "filePart":Lcom/lenovo/leos/cloud/lcp/sync/modules/app/util/FileBodyOffset;
    iget-object v3, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/app/cloud/task/backup/ParentBackupTask;->progressListener:Lcom/lenovo/leos/cloud/lcp/common/ProgressListener;

    invoke-virtual {v1, v3, p0}, Lcom/lenovo/leos/cloud/lcp/sync/modules/app/util/FileBodyOffset;->setListener(Lcom/lenovo/leos/cloud/lcp/common/ProgressListener;Lcom/lenovo/leos/cloud/lcp/sync/modules/common/Task;)V

    .line 106
    const-string v3, "file"

    invoke-virtual {v9, v3, v1}, Lorg/apache/http/entity/mime/MultipartEntity;->addPart(Ljava/lang/String;Lorg/apache/http/entity/mime/content/ContentBody;)V

    .line 108
    :try_start_0
    invoke-virtual {p0, v12, v9}, Lcom/lenovo/leos/cloud/lcp/sync/modules/app/cloud/task/backup/ParentBackupTask;->postForText(Lcom/lenovo/leos/cloud/lcp/common/httpclient/URIRoller;Lorg/apache/http/entity/mime/MultipartEntity;)Ljava/lang/String;
    ...
    const-string v3, "ParentBackupTask"

    invoke-static {v3, v8}, Landroid/util/Log;->w(Ljava/lang/String;Ljava/lang/Throwable;)I
...
.method protected singleUploadApp(Lcom/lenovo/leos/cloud/lcp/sync/modules/app/model/LocalAppInfo;)I
    ...
    .prologue
    .line 69
    invoke-virtual {p1}, Lcom/lenovo/leos/cloud/lcp/sync/modules/app/model/LocalAppInfo;->getAppStatus()Lcom/lenovo/leos/cloud/lcp/sync/modules/app/AppStatus;
...
.method public zipAppdata(Lcom/lenovo/leos/cloud/lcp/sync/modules/app/model/LocalAppInfo;)Ljava/io/File;
    ...
    const-string/jumbo v2, "\u6570\u636e\u62f7\u8d1d\u5230SD\u9519\u8bef\uff01"
    ...
    const-string/jumbo v2, "zip app data error!"
    ...
    invoke-virtual {p1, v1}, Lcom/lenovo/leos/cloud/lcp/sync/modules/app/model/LocalAppInfo;->setAppDataSize(Ljava/lang/Long;)V

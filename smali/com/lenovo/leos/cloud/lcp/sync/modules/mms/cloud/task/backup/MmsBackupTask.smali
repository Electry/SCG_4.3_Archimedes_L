...
.method public constructor <init>(Landroid/content/Context;Ljava/util/List;)V
    ...
    .line 41
    iput-object p2, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/backup/MmsBackupTask;->selectedMmsEntities:Ljava/util/List;
...
.method private backupDifferentMms(Landroid/content/Context;Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/protocol/ChecksumResponse;)V
    ...
    iput v7, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/backup/MmsBackupTask;->countOfUpdate:I
    :try_end_0
...
.method private buildMmsBackupEnties(Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/protocol/ChecksumResponse;)Ljava/util/List;
    ...
    iget-object v2, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/backup/MmsBackupTask;->selectedMmsEntities:Ljava/util/List;
    ...
    .line 205
    invoke-virtual {p0}, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/backup/MmsBackupTask;->isCancelled()Z
...
.method private doMmsBackup(Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/protocol/ChecksumResponse;)Ljava/util/List;
    ...
    iput v1, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/backup/MmsBackupTask;->result:I
    ...
    .line 150
    iget-object v1, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/backup/MmsBackupTask;->mContext:Landroid/content/Context;
    ...
    invoke-virtual {p0, v1}, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/backup/MmsBackupTask;->setProgressStep(I)V
...
.method private startBackupMms(Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/protocol/ChecksumResponse;)V
    ...
    invoke-virtual {p0, v7}, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/backup/MmsBackupTask;->setProgressStep(I)V
    ...
    iget-object v7, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/backup/MmsBackupTask;->mContext:Landroid/content/Context;

    invoke-virtual {p0}, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/backup/MmsBackupTask;->getHttpMachine()Lcom/lenovo/leos/cloud/lcp/common/httpclient/HttpRequestMachine;
    ...
    .line 107
    iget-object v8, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/backup/MmsBackupTask;->mmsDao:Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/dao/MmsDao;

    iget-object v9, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/backup/MmsBackupTask;->mContext:Landroid/content/Context;
    ...
    .line 113
    iget v8, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/backup/MmsBackupTask;->countOfAdd:I

    add-int/lit8 v8, v8, 0x1

    iput v8, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/backup/MmsBackupTask;->countOfAdd:I
    :try_end_1
    ...
    :cond_3
    :try_start_3
    invoke-virtual {p0}, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/backup/MmsBackupTask;->checkCancelOperation()V
    :try_end_3
...
.method public doDiffMms(Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/protocol/ChecksumRequest;Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/protocol/ChecksumResponse;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v3}, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/backup/MmsBackupTask;->getURIRoller(Ljava/lang/String;)Lcom/lenovo/leos/cloud/lcp/common/httpclient/URIRoller;
    ...
    .line 265
    invoke-virtual {p1}, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/protocol/ChecksumRequest;->toBytes()[B

    move-result-object v3

    const/4 v4, 0x1

    invoke-virtual {p0, v2, v3, v4}, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/backup/MmsBackupTask;->postForText(Lcom/lenovo/leos/cloud/lcp/common/httpclient/URIRoller;[BZ)Ljava/lang/String;
...
.method public doQueryLocalMmsNumber(Landroid/content/Context;)Ljava/lang/Integer;
    ...
    .prologue
    .line 50
    iget-object v0, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/backup/MmsBackupTask;->mmsDao:Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/dao/MmsDao;
...
.method protected notifySubProgress(F)V
    ...
    .line 272
    invoke-virtual {p0}, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/backup/MmsBackupTask;->getProgressStep()I
    ...
    invoke-virtual {p0, v0}, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/backup/MmsBackupTask;->notifyProgress(F)V
...
.method public startTaskWithSmoothProgress()V
    ...
    iput-wide v2, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/backup/MmsBackupTask;->start:J

    .line 59
    invoke-virtual {p0}, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/backup/MmsBackupTask;->getRequestEntityFromResover()V
    ...
    invoke-virtual {p0, v1}, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/backup/MmsBackupTask;->doQueryLocalMmsNumber(Landroid/content/Context;)Ljava/lang/Integer;
    ...
    :cond_1
    :goto_0
    iget v1, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/backup/MmsBackupTask;->result:I
    ...
    .line 81
    :cond_3
    iget-object v1, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/backup/MmsBackupTask;->mmsUid2Id:Ljava/util/Map;
    ...
    iget-wide v4, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/backup/MmsBackupTask;->start:J

    sub-long/2addr v2, v4

    iput-wide v2, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/backup/MmsBackupTask;->cost:J

    .line 86
    const-string v2, "LCPMms"

    const-string v3, "MMS_BACKUP"
    ...
    iget v5, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/backup/MmsBackupTask;->result:I

    iget-wide v6, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/backup/MmsBackupTask;->cost:J

    const-string v8, "0"

    iget v1, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/backup/MmsBackupTask;->countOfAdd:I

    iget v9, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/backup/MmsBackupTask;->countOfUpdate:I
    ...
    .line 86
    invoke-virtual/range {v1 .. v9}, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/backup/MmsBackupTask;->reaperRecord(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;IJLjava/lang/String;I)V
    ...
    :try_start_1
    invoke-virtual {p0, v1}, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/backup/MmsBackupTask;->startCompareMms(Z)Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/protocol/ChecksumResponse;
    ...
    .line 72
    invoke-direct {p0, v0}, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/backup/MmsBackupTask;->startBackupMms(Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/protocol/ChecksumResponse;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0

...
.method public createMms(Landroid/content/Context;Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/dao/vo/RequestMmsEntity;Ljava/io/File;)V
    ...
    sget-object v6, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/dao/MmsDaoImpl;->CONTENT_MMS_URI:Landroid/net/Uri;

    .line 403
    .local v6, "mmsPduUri":Landroid/net/Uri;
    :try_start_0
    ...
    invoke-direct {p0, v0, v9, v10, v11}, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/dao/MmsDaoImpl;->getMmsThreadId(Landroid/content/Context;Ljava/lang/String;J)I

    move-result v9

    move-object/from16 v0, p2

    invoke-direct {p0, v9, v0}, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/dao/MmsDaoImpl;->putPduValues(ILcom/lenovo/leos/cloud/lcp/sync/modules/mms/dao/vo/RequestMmsEntity;)Landroid/content/ContentValues;

    move-result-object v9

    invoke-direct {p0, v2, v6, v9}, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/dao/MmsDaoImpl;->insertValues(Landroid/content/ContentResolver;Landroid/net/Uri;Landroid/content/ContentValues;)Landroid/net/Uri;

    move-result-object v7

    .line 404
    .local v7, "newMMS":Landroid/net/Uri;
    ...
    .line 405
    .local v4, "mmsAddrUri":Landroid/net/Uri;
    new-instance v9, Ljava/lang/StringBuilder;
    ...
    .line 408
    .local v5, "mmsPartUri":Landroid/net/Uri;
    ...
    .line 410
    .local v3, "localPhoneNumber":Ljava/lang/String;
    move-object/from16 v0, p2

    invoke-direct {p0, v3, v0}, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/dao/MmsDaoImpl;->putAddrValues(Ljava/lang/String;Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/dao/vo/RequestMmsEntity;)Ljava/util/List;

    move-result-object v9

    invoke-direct {p0, v2, v4, v9}, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/dao/MmsDaoImpl;->insertValues(Landroid/content/ContentResolver;Landroid/net/Uri;Ljava/util/List;)Landroid/net/Uri;
    ...
    .line 419
    .end local v3    # "localPhoneNumber":Ljava/lang/String;
    .end local v4    # "mmsAddrUri":Landroid/net/Uri;
    .end local v5    # "mmsPartUri":Landroid/net/Uri;
    .end local v7    # "newMMS":Landroid/net/Uri;
    .end local v8    # "tm":Landroid/telephony/TelephonyManager;
    :catchall_0
    move-exception v9

    .line 420
    iget-object v10, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/dao/MmsDaoImpl;->tempSmsUri:Landroid/net/Uri;
    ...
    invoke-virtual {v2, v10, v11, v12}, Landroid/content/ContentResolver;->delete(Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)I

    .line 422
    const/4 v10, 0x0

    iput-object v10, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/dao/MmsDaoImpl;->tempSmsUri:Landroid/net/Uri;
    ...
    .line 416
    .restart local v3    # "localPhoneNumber":Ljava/lang/String;
    .restart local v4    # "mmsAddrUri":Landroid/net/Uri;
    .restart local v5    # "mmsPartUri":Landroid/net/Uri;
    .restart local v7    # "newMMS":Landroid/net/Uri;
    .restart local v8    # "tm":Landroid/telephony/TelephonyManager;
    :cond_2
    :try_start_1
    move-object/from16 v0, p3

    invoke-direct {p0, v2, v5, v0}, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/dao/MmsDaoImpl;->insertPartValues(Landroid/content/ContentResolver;Landroid/net/Uri;Ljava/io/File;)Landroid/net/Uri;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    invoke-virtual {v2, v9, v10, v11}, Landroid/content/ContentResolver;->delete(Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)I
...
.method public doQueryLocalMmsNumber(Landroid/content/Context;)Ljava/lang/Integer;
    ...
    const-string/jumbo v3, "msg_box >= ? and msg_box <= ? "

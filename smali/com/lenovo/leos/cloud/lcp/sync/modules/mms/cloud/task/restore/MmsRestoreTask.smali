...
.method public constructor <init>(Landroid/content/Context;Ljava/util/List;)V
    ...
    .line 47
    iput-object p2, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/restore/MmsRestoreTask;->selectedMmsEntities:Ljava/util/List;
...
.method private buildMmsRestoreRequests(Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/protocol/ChecksumResponse;)Ljava/util/List;
    ...
    .prologue
    .line 223
    iget-object v10, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/restore/MmsRestoreTask;->selectedMmsEntities:Ljava/util/List;
    ...
    iput-object v10, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/restore/MmsRestoreTask;->selectedMmsEntities:Ljava/util/List;

    .line 226
    :cond_0
    iget-object v10, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/restore/MmsRestoreTask;->mContext:Landroid/content/Context;
    ...
    .line 247
    invoke-virtual {p0}, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/restore/MmsRestoreTask;->isCancelled()Z
...
.method private doAddRestoreMms(Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/protocol/MmsRestoreRequest;)V
    ...
    iget-object v2, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/restore/MmsRestoreTask;->mContext:Landroid/content/Context;
    ...
    invoke-virtual {p0}, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/restore/MmsRestoreTask;->getHttpMachine()Lcom/lenovo/leos/cloud/lcp/common/httpclient/HttpRequestMachine;
...
.method private getCloudMmsList()Ljava/util/List;
    ...
    .prologue
    .line 255
    const-string/jumbo v0, "phonelist?gzip=false"

    .line 256
    .local v0, "downloadUrl":Ljava/lang/String;
    iget-object v3, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/restore/MmsRestoreTask;->mContext:Landroid/content/Context;
    ...
    invoke-virtual {p0, v2, v3}, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/restore/MmsRestoreTask;->getForText(Lcom/lenovo/leos/cloud/lcp/common/httpclient/URIRoller;Z)Ljava/lang/String;
...
.method private mockEncrpyt()V
    ...
    :try_start_0
    invoke-virtual {p0, v1}, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/restore/MmsRestoreTask;->setProgressStep(I)V
    ...
    .line 204
    invoke-virtual {p0}, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/restore/MmsRestoreTask;->checkCancelOperation()V
    :try_end_0
    ...
    const-string/jumbo v2, "mockEncrpyt InterruptedException"
...
.method private mockGzip()V
    ...
    const-string/jumbo v2, "mockGzip InterruptedException"
...
.method private needRestore(Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/dao/vo/RequestMmsEntity;Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/protocol/ChecksumResponse;)Lorg/json/JSONObject;
    ...
    .line 174
    iget-object v4, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/restore/MmsRestoreTask;->mmsDao:Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/dao/MmsDao;

    iget-object v5, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/restore/MmsRestoreTask;->mContext:Landroid/content/Context;

    iget-object v6, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/restore/MmsRestoreTask;->localMmsEntities:Ljava/util/List;
...
.method private restoreDifferentMms(Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/dao/vo/RequestMmsEntity;Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/protocol/ChecksumResponse;)V
    ...
    iget-object v0, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/restore/MmsRestoreTask;->mmsDao:Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/dao/MmsDao;

    iget-object v1, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/restore/MmsRestoreTask;->mContext:Landroid/content/Context;
...
.method private save(Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/dao/vo/RequestMmsEntity;)V
    ...
    .line 93
    iget v4, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/restore/MmsRestoreTask;->countOfAdd:I

    add-int/lit8 v4, v4, 0x1

    iput v4, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/restore/MmsRestoreTask;->countOfAdd:I
    :try_end_0
...
.method private startRestoreMms(Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/protocol/ChecksumResponse;)V
    ...
    iput v5, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/restore/MmsRestoreTask;->result:I
    ...
    invoke-virtual {p0, v5}, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/restore/MmsRestoreTask;->setProgressStep(I)V
    ...
    .line 137
    .local v4, "size":I
    iget-object v5, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/restore/MmsRestoreTask;->selectedMmsEntities:Ljava/util/List;
    ...
    .line 160
    iget v6, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/restore/MmsRestoreTask;->countOfAdd:I
    ...
    :try_start_0
    iget v6, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/restore/MmsRestoreTask;->countOfUpdate:I
    ...
    iput v6, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/restore/MmsRestoreTask;->countOfUpdate:I
...
.method private wapperResult(Ljava/lang/String;)Ljava/util/List;
    ...
    const-string/jumbo v7, "wapperResult unexcepted JSONException"
...
.method protected notifySubProgress(F)V
    ...
    .line 280
    invoke-virtual {p0}, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/restore/MmsRestoreTask;->getProgressStep()I
    ...
    invoke-virtual {p0, v0}, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/restore/MmsRestoreTask;->notifyProgress(F)V
...
.method public startTaskWithSmoothProgress()V
    ...
    iput-wide v2, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/restore/MmsRestoreTask;->start:J

    .line 56
    invoke-virtual {p0}, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/restore/MmsRestoreTask;->getRequestEntityFromResover()V

    .line 58
    iget-object v1, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/restore/MmsRestoreTask;->mmsDao:Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/dao/MmsDao;

    iget-object v2, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/restore/MmsRestoreTask;->mContext:Landroid/content/Context;

    invoke-interface {v1, v2}, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/dao/MmsDao;->getMmsEntities(Landroid/content/Context;)Ljava/util/List;

    move-result-object v1

    iput-object v1, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/restore/MmsRestoreTask;->localMmsEntities:Ljava/util/List;
    ...
    invoke-virtual {p0, v1}, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/restore/MmsRestoreTask;->startCompareMms(Z)Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/protocol/ChecksumResponse;

    move-result-object v0

    .line 64
    .local v0, "checksum":Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/protocol/ChecksumResponse;
    iget v1, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/restore/MmsRestoreTask;->result:I

    if-nez v1, :cond_0

    .line 65
    invoke-direct {p0, v0}, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/restore/MmsRestoreTask;->startRestoreMms(Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/protocol/ChecksumResponse;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    .line 68
    :cond_0
    iget-object v1, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/restore/MmsRestoreTask;->mmsUid2Id:Ljava/util/Map;
    ...
    .line 71
    :cond_1
    iget v1, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/restore/MmsRestoreTask;->countOfAdd:I
    ...
    const-class v4, Lcom/lenovo/leos/cloud/lcp/sync/modules/smsv2/util/SmsUpdateConversations;
    ...
    .line 74
    :cond_2
    invoke-virtual {p0, v6}, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/restore/MmsRestoreTask;->setProgressStatus(I)V

    .line 75
    invoke-virtual {p0, v5}, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/restore/MmsRestoreTask;->notifySubProgress(F)V
    ...
    iput-wide v2, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/restore/MmsRestoreTask;->cost:J

    .line 78
    const-string v2, "LCPMms"

    const-string v3, "MMS_RESTORE"
    ...
    .line 79
    iget v5, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/restore/MmsRestoreTask;->result:I

    iget-wide v6, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/restore/MmsRestoreTask;->cost:J

    const-string v8, "1"

    iget v1, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/restore/MmsRestoreTask;->countOfAdd:I

    iget v9, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/restore/MmsRestoreTask;->countOfUpdate:I
    ...
    .line 78
    invoke-virtual/range {v1 .. v9}, Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/task/restore/MmsRestoreTask;->reaperRecord(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;IJLjava/lang/String;I)V

    .line 81
    return-void

    .line 67
    .end local v0    # "checksum":Lcom/lenovo/leos/cloud/lcp/sync/modules/mms/cloud/protocol/ChecksumResponse;
    :catchall_0
    move-exception v1

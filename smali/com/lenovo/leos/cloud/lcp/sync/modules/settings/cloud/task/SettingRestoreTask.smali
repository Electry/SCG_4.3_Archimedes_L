...
.method private doDownload(Ljava/lang/String;Ljava/lang/Long;)Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lcom/lenovo/leos/cloud/lcp/sync/modules/settings/cloud/task/SettingRestoreTask;->getHttpMachine()Lcom/lenovo/leos/cloud/lcp/common/httpclient/HttpRequestMachine;
    ...
    iget-object v5, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/settings/cloud/task/SettingRestoreTask;->mContext:Landroid/content/Context;
    ...
    invoke-direct {p0, v1, v2, v6, v7}, Lcom/lenovo/leos/cloud/lcp/sync/modules/settings/cloud/task/SettingRestoreTask;->fromTo(Ljava/io/InputStream;Ljava/io/OutputStream;J)V
...
.method private getSettingCloudBean()Lcom/lenovo/leos/cloud/lcp/file/impl/profiles/ProfilesBackupInfo;
    ...
    iget-object v0, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/settings/cloud/task/SettingRestoreTask;->problemResolver:Lcom/lenovo/leos/cloud/lcp/common/ProblemResolver;
...
.method private getSettingDataById(Ljava/lang/Long;)Lorg/json/JSONObject;
    ...
    const-string/jumbo v5, "v1/getdata?data_id="
    ...
    iget-object v4, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/settings/cloud/task/SettingRestoreTask;->mContext:Landroid/content/Context;
    ...
    invoke-virtual {p0, v2, v4}, Lcom/lenovo/leos/cloud/lcp/sync/modules/settings/cloud/task/SettingRestoreTask;->getForText(Lcom/lenovo/leos/cloud/lcp/common/httpclient/URIRoller;Z)Ljava/lang/String;
...
.method private restoreTask(Lorg/json/JSONObject;)V
    ...
    invoke-virtual {p0, v6}, Lcom/lenovo/leos/cloud/lcp/sync/modules/settings/cloud/task/SettingRestoreTask;->setProgressStatus(I)V
...
.method protected notifySubProgress(F)V
    ...
    .line 138
    iget v0, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/settings/cloud/task/SettingRestoreTask;->progressStatus:I
    ...
    invoke-virtual {p0, v0}, Lcom/lenovo/leos/cloud/lcp/sync/modules/settings/cloud/task/SettingRestoreTask;->notifyProgress(F)V
...
.method protected startTask()V
    ...
    iput-wide v2, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/settings/cloud/task/SettingRestoreTask;->start:J

    .line 44
    const/4 v1, 0x1

    invoke-virtual {p0, v1}, Lcom/lenovo/leos/cloud/lcp/sync/modules/settings/cloud/task/SettingRestoreTask;->setProgressStatus(I)V
    ...
    iget-object v2, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/settings/cloud/task/SettingRestoreTask;->mContext:Landroid/content/Context;
    ...
    iput-object v1, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/settings/cloud/task/SettingRestoreTask;->service:Lcom/lenovo/leos/cloud/lcp/sync/modules/settings/service/SettingService;
    ...
    invoke-virtual {v1}, Lcom/lenovo/leos/cloud/lcp/file/impl/profiles/ProfilesBackupInfo;->getDataId()Ljava/lang/Long;
    ...
    .line 50
    invoke-direct {p0, v0}, Lcom/lenovo/leos/cloud/lcp/sync/modules/settings/cloud/task/SettingRestoreTask;->getSettingDataById(Ljava/lang/Long;)Lorg/json/JSONObject;
    ...
    .line 56
    iget-object v1, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/settings/cloud/task/SettingRestoreTask;->reader:Lcom/lenovo/leos/cloud/lcp/sync/modules/settings/pack/SettingPackageFileReader;
    ...
    iget-wide v4, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/settings/cloud/task/SettingRestoreTask;->start:J

    sub-long/2addr v2, v4

    iput-wide v2, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/settings/cloud/task/SettingRestoreTask;->cost:J

    .line 61
    const-string v2, "LCPSetting"

    const-string v3, "SETTING_RESTORE"

    iget-object v1, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/settings/cloud/task/SettingRestoreTask;->mContext:Landroid/content/Context;

    invoke-virtual {p0, v1}, Lcom/lenovo/leos/cloud/lcp/sync/modules/settings/cloud/task/SettingRestoreTask;->getUserName(Landroid/content/Context;)Ljava/lang/String;

    move-result-object v4

    .line 62
    iget v5, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/settings/cloud/task/SettingRestoreTask;->result:I

    iget-wide v6, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/settings/cloud/task/SettingRestoreTask;->cost:J
    ...
    .line 61
    invoke-virtual/range {v1 .. v9}, Lcom/lenovo/leos/cloud/lcp/sync/modules/settings/cloud/task/SettingRestoreTask;->reaperRecord(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;IJLjava/lang/String;I)V

    .line 64
    .end local v0    # "dataId":Ljava/lang/Long;
    .end local v11    # "resp":Lorg/json/JSONObject;
    :goto_0
    iget v1, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/settings/cloud/task/SettingRestoreTask;->result:I
    ...
    :try_start_1
    sget-object v1, Lcom/lenovo/leos/cloud/lcp/sync/modules/settings/cloud/task/SettingRestoreTask;->TAG:Ljava/lang/String;

...
.method public constructor <init>(Landroid/content/Context;Lcom/lenovo/leos/cloud/lcp/sync/modules/common/TaskID;)V
    ...
    .line 105
    :cond_1
    iget-object v0, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/contact/cloud/task/ContactTask;->mContext:Landroid/content/Context;
    ...
    invoke-virtual {p0, p1}, Lcom/lenovo/leos/cloud/lcp/sync/modules/contact/cloud/task/ContactTask;->getUserName(Landroid/content/Context;)Ljava/lang/String;
...
.method private doSnapshotRawContact()V
    ...
    .line 198
    iget-object v3, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/contact/cloud/task/ContactTask;->mContext:Landroid/content/Context;

    .line 199
    iget-object v4, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/contact/cloud/task/ContactTask;->mContext:Landroid/content/Context;

    invoke-virtual {p0, v4}, Lcom/lenovo/leos/cloud/lcp/sync/modules/contact/cloud/task/ContactTask;->getUserName(Landroid/content/Context;)Ljava/lang/String;
    ...
    .line 220
    iget-object v6, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/contact/cloud/task/ContactTask;->mContext:Landroid/content/Context;

    invoke-virtual {p0, v6}, Lcom/lenovo/leos/cloud/lcp/sync/modules/contact/cloud/task/ContactTask;->getUserName(Landroid/content/Context;)Ljava/lang/String;
...
.method private startContactTask()V
    ...
    .line 242
    iput v7, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/contact/cloud/task/ContactTask;->result:I
    ...
    .line 244
    :cond_1
    iput v5, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/contact/cloud/task/ContactTask;->result:I
...
.method private startSubTask(Lcom/lenovo/leos/cloud/lcp/sync/modules/common/task/CloudTask;I)V
    ...
    iput v0, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/contact/cloud/task/ContactTask;->result:I
...
.method protected doContactCompare()Lcom/lenovo/leos/cloud/lcp/sync/modules/contact/cloud/protocol/ContactChecksumResponse;
    ...
    const-string/jumbo v5, "v4/checksum.action?gzip=true"

    .line 273
    .local v5, "requestUrl":Ljava/lang/String;
    iget-object v8, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/contact/cloud/task/ContactTask;->mContext:Landroid/content/Context;
    ...
    invoke-virtual {p0}, Lcom/lenovo/leos/cloud/lcp/sync/modules/contact/cloud/task/ContactTask;->isCancelled()Z
    ...
    .line 287
    invoke-virtual {v4}, Lcom/lenovo/leos/cloud/lcp/sync/modules/contact/cloud/protocol/ContactChecksumRequest;->toBytes()[B

    move-result-object v8

    const/4 v9, 0x1

    invoke-virtual {p0, v0, v8, v9}, Lcom/lenovo/leos/cloud/lcp/sync/modules/contact/cloud/task/ContactTask;->postForText(Lcom/lenovo/leos/cloud/lcp/common/httpclient/URIRoller;[BZ)Ljava/lang/String;
...
.method protected doFetchServerContactCount()Ljava/lang/String;
    ...
    .line 437
    :try_start_0
    const-string/jumbo v3, "v4/count.action"

    .line 438
    .local v3, "requestUrl":Ljava/lang/String;
    iget-object v7, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/contact/cloud/task/ContactTask;->mContext:Landroid/content/Context;
    ...
    invoke-virtual {p0, v6, v7}, Lcom/lenovo/leos/cloud/lcp/sync/modules/contact/cloud/task/ContactTask;->getForText(Lcom/lenovo/leos/cloud/lcp/common/httpclient/URIRoller;Z)Ljava/lang/String;
...
.method protected doFetchServerVersion()Ljava/lang/Long;
    ...
    .line 419
    :try_start_0
    const-string/jumbo v2, "v4/version.action"
    ...
    invoke-virtual {p0, v5, v6}, Lcom/lenovo/leos/cloud/lcp/sync/modules/contact/cloud/task/ContactTask;->getForText(Lcom/lenovo/leos/cloud/lcp/common/httpclient/URIRoller;Z)Ljava/lang/String;
...
.method public getParams()Landroid/os/Bundle;
    ...
    iget v2, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/contact/cloud/task/ContactTask;->result:I
    ...
    .line 473
    const-string/jumbo v1, "result_local_merge"
    ...
    .line 474
    const-string/jumbo v1, "result_cloud_merge"
...
.method protected notifyProgress(F)V
    ...
    .prologue
    .line 124
    iget-object v0, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/contact/cloud/task/ContactTask;->smoothProgress:Lcom/lenovo/leos/cloud/lcp/common/util/SmoothProgress;
...
.method protected saveContactChecksumValue()V
    ...
    invoke-virtual {v0, v3}, Lcom/lenovo/leos/cloud/lcp/sync/modules/contact/cloud/task/sync/performer/contact/ContactChangeVerifyChecksumBuilder;->buidChecksum(Z)Lcom/lenovo/leos/cloud/lcp/sync/modules/contact/ContactChecksumBuilder$ChecksumResult;
...
.method protected setProgressStep(I)V
    ...
    .line 481
    iput p1, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/contact/cloud/task/ContactTask;->curProgressStep:I

    .line 482
    iget v0, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/contact/cloud/task/ContactTask;->curProgressStep:I
...
.method protected startTask()V
    ...
    .line 138
    iget v0, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/contact/cloud/task/ContactTask;->result:I
    ...
    .line 153
    iget-object v0, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/contact/cloud/task/ContactTask;->taskId:Lcom/lenovo/leos/cloud/lcp/sync/modules/common/TaskID;
    ...
    const-string v3, "CALLLOG_BACKUP"

    iget-object v0, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/contact/cloud/task/ContactTask;->mContext:Landroid/content/Context;

    invoke-virtual {p0, v0}, Lcom/lenovo/leos/cloud/lcp/sync/modules/contact/cloud/task/ContactTask;->getUserName(Landroid/content/Context;)Ljava/lang/String;

    move-result-object v4

    .line 155
    iget v5, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/contact/cloud/task/ContactTask;->result:I

    iget-wide v6, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/contact/cloud/task/ContactTask;->cost:J
    ...
    .line 154
    invoke-virtual/range {v1 .. v9}, Lcom/lenovo/leos/cloud/lcp/sync/modules/contact/cloud/task/ContactTask;->reaperRecord(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;IJLjava/lang/String;I)V
    ...
    iget-wide v4, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/contact/cloud/task/ContactTask;->start:J

    sub-long/2addr v2, v4

    iput-wide v2, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/contact/cloud/task/ContactTask;->cost:J

    .line 153
    iget-object v1, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/contact/cloud/task/ContactTask;->taskId:Lcom/lenovo/leos/cloud/lcp/sync/modules/common/TaskID;

    instance-of v1, v1, Lcom/lenovo/leos/cloud/lcp/sync/modules/common/TaskID$BackupTaskID;
    ...
    iget-object v1, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/contact/cloud/task/ContactTask;->mContext:Landroid/content/Context;

    invoke-virtual {p0, v1}, Lcom/lenovo/leos/cloud/lcp/sync/modules/contact/cloud/task/ContactTask;->getUserName(Landroid/content/Context;)Ljava/lang/String;
    ...
    iget v9, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/contact/cloud/task/ContactTask;->opDeleteCount:I

    add-int/2addr v1, v9

    iget v9, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/contact/cloud/task/ContactTask;->opUpdateCount:I
    ...
    .line 164
    iget-object v1, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/contact/cloud/task/ContactTask;->smoothProgress:Lcom/lenovo/leos/cloud/lcp/common/util/SmoothProgress;
    ...
    instance-of v1, v1, Lcom/lenovo/leos/cloud/lcp/sync/modules/common/TaskID$RestoreTaskID;
    ...
    const-string v3, "CALLLOG_RESTORE"

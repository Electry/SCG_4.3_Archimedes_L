...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/app/sdcard/task/AppSDcardBackupTask;->appInfos:Ljava/util/List;

    .line 41
    iget-object v0, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/app/sdcard/task/AppSDcardBackupTask;->appInfos:Ljava/util/List;
...
.method static synthetic access$0(Lcom/lenovo/leos/cloud/lcp/sync/modules/app/sdcard/task/AppSDcardBackupTask;F)V
    ...
    .prologue
    .line 1
    invoke-virtual {p0, p1}, Lcom/lenovo/leos/cloud/lcp/sync/modules/app/sdcard/task/AppSDcardBackupTask;->notifyProgress(F)V
...
.method static synthetic access$2(Lcom/lenovo/leos/cloud/lcp/sync/modules/app/sdcard/task/AppSDcardBackupTask;)Landroid/content/Context;
    ...
    .prologue
    .line 24
    iget-object v0, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/app/sdcard/task/AppSDcardBackupTask;->mContext:Landroid/content/Context;
...
.method private resovleBackupFilePath()V
    ...
    .prologue
    .line 111
    iget-object v0, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/app/sdcard/task/AppSDcardBackupTask;->problemResolver:Lcom/lenovo/leos/cloud/lcp/common/ProblemResolver;
...
.method private startAppSDCardBackup()V
    ...
    invoke-virtual {p0, v0}, Lcom/lenovo/leos/cloud/lcp/sync/modules/app/sdcard/task/AppSDcardBackupTask;->setProgressStep(I)V
    ...
    iput v0, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/app/sdcard/task/AppSDcardBackupTask;->result:I
    ...
    iget-object v1, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/app/sdcard/task/AppSDcardBackupTask;->mContext:Landroid/content/Context;

    iget-wide v4, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/app/sdcard/task/AppSDcardBackupTask;->time:J

    iget-object v6, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/app/sdcard/task/AppSDcardBackupTask;->appInfos:Ljava/util/List;
    ...
    iget-object v4, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/app/sdcard/task/AppSDcardBackupTask;->mContext:Landroid/content/Context;

    iget-object v5, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/app/sdcard/task/AppSDcardBackupTask;->appInfos:Ljava/util/List;
...
.method private writeMetaInfo(Lcom/lenovo/leos/cloud/lcp/sync/modules/app/sdcard/protocol/AppBackupRequest;)V
    ...
    .line 121
    iget-object v2, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/app/sdcard/task/AppSDcardBackupTask;->appInfos:Ljava/util/List;
    ...
    iget-object v3, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/app/sdcard/task/AppSDcardBackupTask;->mContext:Landroid/content/Context;
...
.method public cancel()V
    ...
    .prologue
    .line 139
    invoke-super {p0}, Lcom/lenovo/leos/cloud/lcp/sync/modules/app/sdcard/task/AppSDCardTask;->cancel()V
...
.method protected startTask()V
    ...
    iput-wide v2, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/app/sdcard/task/AppSDcardBackupTask;->start:J
    ...
    :try_start_0
    invoke-virtual {p0, v1}, Lcom/lenovo/leos/cloud/lcp/sync/modules/app/sdcard/task/AppSDcardBackupTask;->setProgressStep(I)V
    ...
    .line 55
    invoke-virtual {p0}, Lcom/lenovo/leos/cloud/lcp/sync/modules/app/sdcard/task/AppSDcardBackupTask;->notifyFinish()V

    .line 57
    iget v1, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/app/sdcard/task/AppSDcardBackupTask;->result:I

    if-eqz v1, :cond_1

    .line 59
    :try_start_1
    iget-object v1, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/app/sdcard/task/AppSDcardBackupTask;->writer:Lcom/lenovo/leos/cloud/lcp/sync/modules/common/sdcard/io/AppPackageFileWriterV2;

    iget-object v2, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/app/sdcard/task/AppSDcardBackupTask;->mContext:Landroid/content/Context;

    iget-wide v4, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/app/sdcard/task/AppSDcardBackupTask;->time:J

    new-instance v3, Ljava/lang/StringBuilder;

    iget-object v6, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/app/sdcard/task/AppSDcardBackupTask;->fileFullPath:Ljava/lang/String;
    ...
    invoke-virtual {v1, v2, v4, v5, v3}, Lcom/lenovo/leos/cloud/lcp/sync/modules/common/sdcard/io/AppPackageFileWriterV2;->deleteFile(Landroid/content/Context;JLjava/lang/String;)Z
    :try_end_1
    ...
    iget-wide v4, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/app/sdcard/task/AppSDcardBackupTask;->start:J

    sub-long/2addr v2, v4

    iput-wide v2, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/app/sdcard/task/AppSDcardBackupTask;->cost:J

    .line 67
    const-string v2, "LCPApp"

    const-string v3, "SDCARD_APP_BACKUP"
    ...
    .line 68
    iget v5, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/app/sdcard/task/AppSDcardBackupTask;->result:I

    iget-wide v6, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/app/sdcard/task/AppSDcardBackupTask;->cost:J

    const-string v8, "0"

    iget v9, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/app/sdcard/task/AppSDcardBackupTask;->countOfAdd:I

    move-object v1, p0

    .line 67
    invoke-virtual/range {v1 .. v9}, Lcom/lenovo/leos/cloud/lcp/sync/modules/app/sdcard/task/AppSDcardBackupTask;->reaperRecord(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;IJLjava/lang/String;I)V
    ...
    invoke-virtual {v1}, Lcom/lenovo/leos/cloud/lcp/sync/modules/common/sdcard/io/AppPackageFileWriterV2;->convert2RealFile()Z

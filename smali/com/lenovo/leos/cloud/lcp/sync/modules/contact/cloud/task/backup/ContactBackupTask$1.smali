...
.method private updateRawContactSID(Landroid/os/Bundle;)V
    ...
    # getter for: Lcom/lenovo/leos/cloud/lcp/sync/modules/contact/cloud/task/backup/ContactBackupTask;->contactDao:Lcom/lenovo/leos/cloud/lcp/sync/modules/contact/dao/RawContactDao;
...
.method public onVisit(Landroid/os/Bundle;)Z
    ...
    # getter for: Lcom/lenovo/leos/cloud/lcp/sync/modules/contact/cloud/task/backup/ContactBackupTask;->opDeleteCount:I
    ...
    # getter for: Lcom/lenovo/leos/cloud/lcp/sync/modules/contact/cloud/task/backup/ContactBackupTask;->sid2cidMap:Ljava/util/Map;
    ...
    # getter for: Lcom/lenovo/leos/cloud/lcp/sync/modules/contact/cloud/task/backup/ContactBackupTask;->mContext:Landroid/content/Context;
    ...
    invoke-virtual {v3, v4}, Lcom/lenovo/leos/cloud/lcp/sync/modules/contact/cloud/task/backup/ContactBackupTask;->getUserName(Landroid/content/Context;)Ljava/lang/String;
    ...
    # getter for: Lcom/lenovo/leos/cloud/lcp/sync/modules/contact/cloud/task/backup/ContactBackupTask;->dbCommistSize:I
    ...
    # invokes: Lcom/lenovo/leos/cloud/lcp/sync/modules/contact/cloud/task/backup/ContactBackupTask;->digestDBBatchOperation(Ljava/util/List;)[Landroid/content/ContentProviderResult;
    ...
    invoke-virtual {v1}, Lcom/lenovo/leos/cloud/lcp/sync/modules/contact/cloud/task/backup/ContactBackupTask;->isCancelled()Z
    ...
    # getter for: Lcom/lenovo/leos/cloud/lcp/sync/modules/contact/cloud/task/backup/ContactBackupTask;->opAddCount:I
    ...
    # getter for: Lcom/lenovo/leos/cloud/lcp/sync/modules/contact/cloud/task/backup/ContactBackupTask;->opUpdateCount:I

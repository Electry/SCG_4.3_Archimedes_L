...
.method public createZip(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string/jumbo v7, "this folder isnot exist!"
...
.method public testReadZip()V
    ...
    .local v4, "readLen":I
    :goto_1
    invoke-virtual {v2, v1, v10, v11}, Ljava/io/InputStream;->read([BII)I
    ...
    .line 233
    :cond_2
    invoke-virtual {v3, v1, v10, v4}, Ljava/io/OutputStream;->write([BII)V

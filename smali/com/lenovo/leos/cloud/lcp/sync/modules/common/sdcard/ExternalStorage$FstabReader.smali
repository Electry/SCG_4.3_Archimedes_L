...
.method private browseFstabFile(Lcom/lenovo/leos/cloud/lcp/sync/modules/common/sdcard/ExternalStorage$FstabReader$OnFsFoundListener;Ljava/io/File;)V
    ...
    invoke-direct {v7, v13, v14}, Ljava/io/InputStreamReader;-><init>(Ljava/io/InputStream;Ljava/lang/String;)V
    :try_end_0
    ...
    .line 426
    .local v8, "rootPath":Ljava/io/File;
    ...
    .line 427
    new-instance v11, Lcom/lenovo/leos/cloud/lcp/sync/modules/common/sdcard/ExternalStorage$StorageInfo;

    invoke-direct {v11}, Lcom/lenovo/leos/cloud/lcp/sync/modules/common/sdcard/ExternalStorage$StorageInfo;-><init>()V

    .line 428
    .local v11, "storage":Lcom/lenovo/leos/cloud/lcp/sync/modules/common/sdcard/ExternalStorage$StorageInfo;
    invoke-virtual {v10}, Landroid/os/StatFs;->getAvailableBlocks()I

    move-result v13

    iput v13, v11, Lcom/lenovo/leos/cloud/lcp/sync/modules/common/sdcard/ExternalStorage$StorageInfo;->availableBlocks:I
    ...
    iput-wide v14, v11, Lcom/lenovo/leos/cloud/lcp/sync/modules/common/sdcard/ExternalStorage$StorageInfo;->availableSpace:J
    ...
    iput-wide v14, v11, Lcom/lenovo/leos/cloud/lcp/sync/modules/common/sdcard/ExternalStorage$StorageInfo;->totalSpace:J

    .line 431
    iput-object v5, v11, Lcom/lenovo/leos/cloud/lcp/sync/modules/common/sdcard/ExternalStorage$StorageInfo;->rootPath:Ljava/lang/String;

    .line 432
    move-object/from16 v0, p1

    invoke-interface {v0, v11}, Lcom/lenovo/leos/cloud/lcp/sync/modules/common/sdcard/ExternalStorage$FstabReader$OnFsFoundListener;->onFsFound(Lcom/lenovo/leos/cloud/lcp/sync/modules/common/sdcard/ExternalStorage$StorageInfo;)V

    .line 436
    .end local v5    # "path":Ljava/lang/String;
    .end local v8    # "rootPath":Ljava/io/File;
    .end local v10    # "stat":Landroid/os/StatFs;
    .end local v11    # "storage":Lcom/lenovo/leos/cloud/lcp/sync/modules/common/sdcard/ExternalStorage$StorageInfo;
    ...
    invoke-static {v14}, Lcom/lenovo/leos/cloud/lcp/common/util/IOUtil;->close([Ljava/io/Closeable;)V

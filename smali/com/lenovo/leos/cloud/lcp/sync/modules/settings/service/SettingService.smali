...
.method private buildSettingByType(Lcom/lenovo/leos/cloud/lcp/sync/modules/settings/pack/SettingPackageFileWriter;Lorg/json/JSONObject;Lcom/lenovo/leos/cloud/lcp/sync/modules/settings/dao/po/SettingKey;)V
    ...
    iget-object v2, v0, Lcom/lenovo/leos/cloud/lcp/sync/modules/settings/service/SettingService;->dao:Lcom/lenovo/leos/cloud/lcp/sync/modules/settings/dao/SettingDao;

    const/4 v5, 0x0

    invoke-interface {v2, v12, v5}, Lcom/lenovo/leos/cloud/lcp/sync/modules/settings/dao/SettingDao;->getInt(Ljava/lang/String;I)I
    ...
    invoke-virtual {v0, v12, v15}, Lorg/json/JSONObject;->put(Ljava/lang/String;I)Lorg/json/JSONObject;
    :try_end_0
    ...
    const-string/jumbo v5, "\u53d6\u4e0d\u5230\u76f8\u5e94\u7684setting\u6570\u636e"

    invoke-static {v2, v5, v10}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    :try_end_1
    ...
    invoke-interface {v2, v12, v5}, Lcom/lenovo/leos/cloud/lcp/sync/modules/settings/dao/SettingDao;->getString(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-interface {v2, v12, v5}, Lcom/lenovo/leos/cloud/lcp/sync/modules/settings/dao/SettingDao;->getFloat(Ljava/lang/String;F)F
    ...
    invoke-virtual {v0, v12, v6, v7}, Lorg/json/JSONObject;->put(Ljava/lang/String;D)Lorg/json/JSONObject;
    ...
    invoke-interface {v2, v12, v6, v7}, Lcom/lenovo/leos/cloud/lcp/sync/modules/settings/dao/SettingDao;->getLong(Ljava/lang/String;J)J
    ...
    .line 227
    .local v14, "uriValue":Ljava/lang/String;
    ...
    iget-object v2, v0, Lcom/lenovo/leos/cloud/lcp/sync/modules/settings/service/SettingService;->context:Landroid/content/Context;
    ...
    .line 234
    .local v8, "actualImageColumnIndex":I
    ...
    invoke-virtual {v0, v11}, Lcom/lenovo/leos/cloud/lcp/sync/modules/settings/pack/SettingPackageFileWriter;->writePackageItem(Ljava/lang/String;)Ljava/lang/String;
...
.method private buildWallpaper(Lorg/json/JSONObject;Lcom/lenovo/leos/cloud/lcp/sync/modules/settings/pack/SettingPackageFileWriter;)V
    ...
    const-string/jumbo v4, "\u53d6\u4e0d\u5230\u76f8\u5e94\u7684setting\u6570\u636e"
...
.method private putSettingByType(Lorg/json/JSONObject;Lcom/lenovo/leos/cloud/lcp/sync/modules/settings/pack/SettingPackageFileReader;Lcom/lenovo/leos/cloud/lcp/sync/modules/settings/dao/po/SettingKey;)V
    ...
    iget-object v14, v0, Lcom/lenovo/leos/cloud/lcp/sync/modules/settings/service/SettingService;->context:Landroid/content/Context;
    ...
    iget-object v15, v0, Lcom/lenovo/leos/cloud/lcp/sync/modules/settings/service/SettingService;->dao:Lcom/lenovo/leos/cloud/lcp/sync/modules/settings/dao/SettingDao;

    const/16 v16, 0x0

    move-object/from16 v0, v16

    invoke-interface {v15, v6, v0}, Lcom/lenovo/leos/cloud/lcp/sync/modules/settings/dao/SettingDao;->getUriFor(Ljava/lang/String;Landroid/net/Uri;)Landroid/net/Uri;
    ...
    invoke-interface {v14, v6, v5}, Lcom/lenovo/leos/cloud/lcp/sync/modules/settings/dao/SettingDao;->putInt(Ljava/lang/String;I)Z
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v14, "SettingService"

    const-string/jumbo v15, "\u653e\u5165\u8bbe\u7f6e\u5c5e\u6027\u9519\u8bef\uff0c"
    ...
    invoke-interface {v14, v6, v10}, Lcom/lenovo/leos/cloud/lcp/sync/modules/settings/dao/SettingDao;->putString(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-interface {v14, v6, v4}, Lcom/lenovo/leos/cloud/lcp/sync/modules/settings/dao/SettingDao;->putFloat(Ljava/lang/String;F)Z

    goto :goto_1

    .line 106
    .end local v4    # "fValue":F
    :pswitch_3
    invoke-virtual {v13}, Ljava/lang/Object;->toString()Ljava/lang/String;
    ...
    invoke-interface {v14, v6, v8, v9}, Lcom/lenovo/leos/cloud/lcp/sync/modules/settings/dao/SettingDao;->putLong(Ljava/lang/String;J)Z
    ...
    .line 111
    .local v12, "uriValue":Ljava/lang/String;
    const-string v14, "/"
    ...
    .line 114
    :try_start_2
    new-instance v14, Lcom/lenovo/leos/cloud/lcp/sync/modules/settings/service/SettingService$2;

    move-object/from16 v0, p0

    invoke-direct {v14, v0, v12}, Lcom/lenovo/leos/cloud/lcp/sync/modules/settings/service/SettingService$2;-><init>(Lcom/lenovo/leos/cloud/lcp/sync/modules/settings/service/SettingService;Ljava/lang/String;)V

    move-object/from16 v0, p2

    invoke-virtual {v0, v3, v14}, Lcom/lenovo/leos/cloud/lcp/sync/modules/settings/pack/SettingPackageFileReader;->readPackageItem(Ljava/lang/String;Lcom/lenovo/leos/cloud/lcp/sync/modules/settings/pack/SettingPackageFileReader$PackageReaderCallback;)V
    :try_end_2
    ...
    invoke-direct {v0, v12}, Lcom/lenovo/leos/cloud/lcp/sync/modules/settings/service/SettingService;->getUri(Ljava/lang/String;)Landroid/net/Uri;
    ...
    invoke-interface {v14, v6, v7}, Lcom/lenovo/leos/cloud/lcp/sync/modules/settings/dao/SettingDao;->putString(Ljava/lang/String;Ljava/lang/String;)Z

...
.method public doAction(Lcom/lenovo/leos/cloud/lcp/sync/modules/calendar/cloud/protocol/EventChecksumResponse;)Lcom/lenovo/leos/cloud/lcp/sync/modules/calendar/cloud/protocol/SubEventBackupResponse;
    ...
    invoke-virtual {p0, v4}, Lcom/lenovo/leos/cloud/lcp/sync/modules/calendar/cloud/task/backup/SubEventStep;->setProgressStatus(I)V

    .line 52
    new-instance v2, Lcom/lenovo/leos/cloud/lcp/sync/modules/calendar/cloud/protocol/helper/impl/SubEventSyncRequestBuilder;

    iget-object v4, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calendar/cloud/task/backup/SubEventStep;->context:Landroid/content/Context;

    iget-object v5, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calendar/cloud/task/backup/SubEventStep;->task:Lcom/lenovo/leos/cloud/lcp/sync/modules/common/Task;
    ...
    invoke-virtual {v0}, Lcom/lenovo/leos/cloud/lcp/sync/modules/calendar/cloud/protocol/SubEventBackupRequest;->getBackupReqSize()I
    ...
    .line 58
    const-string/jumbo v4, "v1/partbackup.action"

    invoke-virtual {p0, v4}, Lcom/lenovo/leos/cloud/lcp/sync/modules/calendar/cloud/task/backup/SubEventStep;->buildURIRoller(Ljava/lang/String;)Lcom/lenovo/leos/cloud/lcp/common/httpclient/BizURIRoller;
    ...
    invoke-virtual {v0}, Lcom/lenovo/leos/cloud/lcp/sync/modules/calendar/cloud/protocol/SubEventBackupRequest;->toBytes()[B

    move-result-object v5

    const/4 v6, 0x1

    invoke-virtual {p0, v3, v5, v6}, Lcom/lenovo/leos/cloud/lcp/sync/modules/calendar/cloud/task/backup/SubEventStep;->postForText(Lcom/lenovo/leos/cloud/lcp/common/httpclient/URIRoller;[BZ)Ljava/lang/String;
...
.method public doCheckSum()Lcom/lenovo/leos/cloud/lcp/sync/modules/calendar/cloud/protocol/EventChecksumResponse;
    ...
    invoke-virtual {p0, v5}, Lcom/lenovo/leos/cloud/lcp/sync/modules/calendar/cloud/task/backup/SubEventStep;->setProgressStatus(I)V

    .line 31
    new-instance v0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calendar/cloud/protocol/helper/impl/SubEventChecksumBuilder;

    iget-object v5, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calendar/cloud/task/backup/SubEventStep;->context:Landroid/content/Context;

    iget-object v6, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calendar/cloud/task/backup/SubEventStep;->task:Lcom/lenovo/leos/cloud/lcp/sync/modules/common/Task;
    ...
    invoke-virtual {p0, v5}, Lcom/lenovo/leos/cloud/lcp/sync/modules/calendar/cloud/task/backup/SubEventStep;->buildURIRoller(Ljava/lang/String;)Lcom/lenovo/leos/cloud/lcp/common/httpclient/BizURIRoller;
    ...
    invoke-virtual {p0, v4, v5, v6}, Lcom/lenovo/leos/cloud/lcp/sync/modules/calendar/cloud/task/backup/SubEventStep;->postForText(Lcom/lenovo/leos/cloud/lcp/common/httpclient/URIRoller;[BZ)Ljava/lang/String;
...
.method public handleResult(Lcom/lenovo/leos/cloud/lcp/sync/modules/calendar/cloud/protocol/SubEventBackupResponse;)Lcom/lenovo/leos/cloud/lcp/sync/modules/contact/manager/vo/TaskResult;
    ...
    invoke-virtual {p0, v2}, Lcom/lenovo/leos/cloud/lcp/sync/modules/calendar/cloud/task/backup/SubEventStep;->setProgressStatus(I)V

    .line 73
    :try_start_0
    new-instance v1, Lcom/lenovo/leos/cloud/lcp/sync/modules/calendar/cloud/protocol/helper/impl/SubEventSyncResponseHandler;

    iget-object v2, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calendar/cloud/task/backup/SubEventStep;->context:Landroid/content/Context;

    iget-object v3, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calendar/cloud/task/backup/SubEventStep;->task:Lcom/lenovo/leos/cloud/lcp/sync/modules/common/Task;

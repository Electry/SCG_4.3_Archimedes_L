...
.method static synthetic access$3(Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/sdcard/task/CalllogSDcardBackupTask;I)V
    ...
    .prologue
    .line 32
    iput p1, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/sdcard/task/CalllogSDcardBackupTask;->result:I
...
.method static synthetic access$5(Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/sdcard/task/CalllogSDcardBackupTask;)Landroid/content/Context;
    ...
    .prologue
    .line 32
    iget-object v0, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/sdcard/task/CalllogSDcardBackupTask;->mContext:Landroid/content/Context;
...
.method private buildSDCardBackupCalllog()Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/protocol/CalllogBackupRequest;
    ...
    invoke-virtual {p0, v2}, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/sdcard/task/CalllogSDcardBackupTask;->setProgressStep(I)V

    .line 156
    iget-object v2, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/sdcard/task/CalllogSDcardBackupTask;->calllogDao:Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/dao/CalllogDao;

    iget-object v3, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/sdcard/task/CalllogSDcardBackupTask;->mContext:Landroid/content/Context;
    ...
    iput v2, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/sdcard/task/CalllogSDcardBackupTask;->result:I
...
.method private resovleBackupFilePath()V
    ...
    .prologue
    .line 98
    iget-object v0, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/sdcard/task/CalllogSDcardBackupTask;->problemResolver:Lcom/lenovo/leos/cloud/lcp/common/ProblemResolver;
...
.method private writeMetaInfo()V
    ...
    iget-object v2, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/sdcard/task/CalllogSDcardBackupTask;->mContext:Landroid/content/Context;
...
.method private writeToFile(Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/protocol/CalllogBackupRequest;)V
    ...
    .line 120
    :try_start_0
    invoke-virtual {p0}, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/sdcard/task/CalllogSDcardBackupTask;->isCancelled()Z
    ...
    iput v0, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/sdcard/task/CalllogSDcardBackupTask;->result:I
    ...
    iget-object v1, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/sdcard/task/CalllogSDcardBackupTask;->mContext:Landroid/content/Context;
    ...
    iput v10, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/sdcard/task/CalllogSDcardBackupTask;->result:I
...
.method public cancel()V
    ...
    .prologue
    .line 192
    invoke-super {p0}, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/sdcard/task/CalllogSDCardTask;->cancel()V
...
.method public getParams()Landroid/os/Bundle;
    ...
    .prologue
    .line 185
    invoke-super {p0}, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/sdcard/task/CalllogSDCardTask;->getParams()Landroid/os/Bundle;
...
.method protected notifyStepProgress(F)V
    ...
    .prologue
    .line 218
    iget v0, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/sdcard/task/CalllogSDcardBackupTask;->progressStep:I
    ...
    invoke-virtual {p0, v0}, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/sdcard/task/CalllogSDcardBackupTask;->notifyProgress(F)V
...
.method protected startTask()V
    ...
    iput-wide v2, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/sdcard/task/CalllogSDcardBackupTask;->start:J

    .line 64
    const/4 v1, 0x1

    invoke-virtual {p0, v1}, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/sdcard/task/CalllogSDcardBackupTask;->setProgressStep(I)V
    ...
    invoke-virtual {p0, v1}, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/sdcard/task/CalllogSDcardBackupTask;->doQuaryLocalCalllogNumber(Landroid/content/Context;)I
    ...
    iput v1, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/sdcard/task/CalllogSDcardBackupTask;->result:I
    :try_end_0
    ...
    :cond_0
    :goto_0
    invoke-virtual {p0, v5}, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/sdcard/task/CalllogSDcardBackupTask;->setProgressStep(I)V
    ...
    .line 86
    :goto_1
    iget v1, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/sdcard/task/CalllogSDcardBackupTask;->result:I
    ...
    iget-wide v4, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/sdcard/task/CalllogSDcardBackupTask;->start:J

    sub-long/2addr v2, v4

    iput-wide v2, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/sdcard/task/CalllogSDcardBackupTask;->cost:J

    .line 92
    const-string v2, "LCPCalllog"

    const-string v3, "SDCARD_CALLLOG_BACKUP"
    ...
    .line 93
    iget v5, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/sdcard/task/CalllogSDcardBackupTask;->result:I

    iget-wide v6, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/sdcard/task/CalllogSDcardBackupTask;->cost:J

    const-string v8, "0"

    iget v1, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/sdcard/task/CalllogSDcardBackupTask;->countOfAdd:I

    iget v9, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/sdcard/task/CalllogSDcardBackupTask;->countOfUpdate:I
    ...
    .line 92
    invoke-virtual/range {v1 .. v9}, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/sdcard/task/CalllogSDcardBackupTask;->reaperRecord(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;IJLjava/lang/String;I)V
    ...
    const-string/jumbo v2, "startTask IOException"

    invoke-static {v1, v2, v0}, Landroid/util/Log;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I

    .line 84
    iput v4, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calllog/sdcard/task/CalllogSDcardBackupTask;->result:I
    ...
    invoke-virtual {v1}, Lcom/lenovo/leos/cloud/lcp/sync/modules/common/sdcard/io/PackageFileWriter;->convert2RealFile()Z

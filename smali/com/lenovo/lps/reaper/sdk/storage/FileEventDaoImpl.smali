...
.method public getEvents(ILcom/lenovo/lps/reaper/sdk/util/Constants$StorageQueue$Priority;)[Lcom/lenovo/lps/reaper/sdk/api/Event;
    ...
    .line 111
    .local v32, "events":[Lcom/lenovo/lps/reaper/sdk/api/Event;
    move-object/from16 v0, p0
    ...
    invoke-virtual/range {v28 .. v28}, Ljava/nio/ByteBuffer;->getDouble()D
    ...
    .line 132
    .local v27, "userIdClass":Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    .line 133
    .local v29, "param":Lcom/lenovo/lps/reaper/sdk/api/ParamMap;
    new-instance v4, Lcom/lenovo/lps/reaper/sdk/api/Event;

    move-object/from16 v28, p2

    invoke-direct/range {v4 .. v29}, Lcom/lenovo/lps/reaper/sdk/api/Event;-><init>(JILjava/lang/String;IJJJJILjava/lang/String;Ljava/lang/String;Ljava/lang/String;DIILjava/lang/String;Ljava/lang/String;Lcom/lenovo/lps/reaper/sdk/util/Constants$StorageQueue$Priority;Lcom/lenovo/lps/reaper/sdk/api/ParamMap;)V
    ...
    .end local v9    # "randomVal":I
    .end local v10    # "timestampFirst":J
    .end local v12    # "timestampPre":J
    .end local v14    # "timestampCur":J
    .end local v16    # "timestampEvent":J
    ...
    .end local v24    # "networkStatus":I
    .end local v25    # "netSubType":I
    .end local v26    # "userId":Ljava/lang/String;
    .end local v27    # "userIdClass":Ljava/lang/String;
    .end local v29    # "param":Lcom/lenovo/lps/reaper/sdk/api/ParamMap;
    :cond_1
    ...
    .local v30, "arr$":[Lcom/lenovo/lps/reaper/sdk/api/Event;
    ...
    aget-object v4, v30, v35

    .line 141
    .restart local v4    # "event":Lcom/lenovo/lps/reaper/sdk/api/Event;
    invoke-virtual {v4}, Lcom/lenovo/lps/reaper/sdk/api/Event;->printLog()V
    ...
    .line 144
    .end local v4    # "event":Lcom/lenovo/lps/reaper/sdk/api/Event;
    .end local v30    # "arr$":[Lcom/lenovo/lps/reaper/sdk/api/Event;
    .end local v35    # "i$":I
    .end local v37    # "len$":I
    :cond_2
    monitor-exit v39
    ...
    .line 149
    .end local v31    # "eveNum":I
    .end local v32    # "events":[Lcom/lenovo/lps/reaper/sdk/api/Event;
    .end local v34    # "i":I
    ...
    .line 147
    .local v33, "ex":Ljava/lang/Exception;
    const-string v28, "FileEventDaoImpl"

    new-instance v39, Ljava/lang/StringBuilder;

    invoke-direct/range {v39 .. v39}, Ljava/lang/StringBuilder;-><init>()V

    const-string v40, "Error when fetch Event object from storage. "

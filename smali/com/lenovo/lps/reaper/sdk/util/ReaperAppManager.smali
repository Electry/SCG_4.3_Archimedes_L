...
.method private trafficStatistics(Landroid/content/Context;)Lcom/lenovo/lps/reaper/sdk/util/TrafficItem;
    ...
    const-string/jumbo v10, "not found this process."
    ...
    invoke-direct {v8, v4, v5, v6, v7}, Lcom/lenovo/lps/reaper/sdk/util/TrafficItem;-><init>(JJ)V
...
.method public isTimeForAddSessionVisits()Z
    ...
    .restart local v1    # "pauseTimeFlag":Z
    :cond_1
    move v0, v5
...
.method public recordEventEnd(Ljava/lang/String;)J
    ...
    invoke-static {v1, v4}, Lcom/lenovo/lps/reaper/sdk/util/TLog;->e(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string/jumbo v5, "not found this begin event of this event action: "
...
.method public recordPause(Ljava/lang/String;)J
    ...
    const-string/jumbo v5, "not found resume event of this page: "
...
.method public saveTrafficNumber(Landroid/content/Context;)Lcom/lenovo/lps/reaper/sdk/util/TrafficItem;
    ...
    .prologue
    .line 172
    const-string/jumbo v14, "traffic"
    ...
    const-string/jumbo v14, "traffic_rx"
    ...
    .line 175
    .local v8, "lastRxTrafficNumber":J
    const-string/jumbo v14, "traffic_tx"
    ...
    .line 176
    .local v10, "lastTxTrafficNumber":J
    const-string v14, "ReaperAppManager"

    new-instance v15, Ljava/lang/StringBuilder;

    invoke-direct {v15}, Ljava/lang/StringBuilder;-><init>()V

    const-string v16, "lastRxTrafficNumber: "
    ...
    invoke-static {v14, v15}, Lcom/lenovo/lps/reaper/sdk/util/TLog;->i(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v16, "lastTxTrafficNumber: "
    ...
    .line 179
    .local v5, "curTrafficItem":Lcom/lenovo/lps/reaper/sdk/util/TrafficItem;
    if-nez v5, :cond_1
    ...
    const-string v16, "curRxTrafficNumber: "

    invoke-virtual/range {v15 .. v16}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v15

    invoke-virtual {v5}, Lcom/lenovo/lps/reaper/sdk/util/TrafficItem;->getRxBytes()J
    ...
    const-string v16, "curTxTrafficNumber: "

    invoke-virtual/range {v15 .. v16}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v15

    invoke-virtual {v5}, Lcom/lenovo/lps/reaper/sdk/util/TrafficItem;->getTxBytes()J
    ...
    .line 185
    .local v2, "addedRxbytes":J
    const-wide/16 v6, 0x0

    .line 186
    .local v6, "addedTxbytes":J
    new-instance v4, Lcom/lenovo/lps/reaper/sdk/util/TrafficItem;

    invoke-direct {v4, v2, v3, v6, v7}, Lcom/lenovo/lps/reaper/sdk/util/TrafficItem;-><init>(JJ)V

    .line 187
    .local v4, "addedTrafficItem":Lcom/lenovo/lps/reaper/sdk/util/TrafficItem;
    invoke-virtual {v5}, Lcom/lenovo/lps/reaper/sdk/util/TrafficItem;->getRxBytes()J
    ...
    const-string/jumbo v15, "traffic_rx"
    ...
    invoke-virtual {v4, v14, v15}, Lcom/lenovo/lps/reaper/sdk/util/TrafficItem;->setRxBytes(J)V

    .line 196
    .end local v13    # "succ":Z
    :cond_2
    :goto_1
    invoke-virtual {v5}, Lcom/lenovo/lps/reaper/sdk/util/TrafficItem;->getTxBytes()J
    ...
    const-string/jumbo v15, "traffic_tx"
    ...
    invoke-virtual {v4, v14, v15}, Lcom/lenovo/lps/reaper/sdk/util/TrafficItem;->setTxBytes(J)V
    ...
    const-string/jumbo v15, "put rx traffic data error"
    ...
    const-string/jumbo v15, "put tx traffic data error"

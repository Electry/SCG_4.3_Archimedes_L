...
.method private processResponseResult(Ljava/lang/String;)V
    ...
    const-string/jumbo v10, "process response fail. "
...
.method public processHttpRequest()V
    ...
    invoke-virtual {v8, v0}, Lorg/apache/http/impl/client/DefaultHttpClient;->setHttpRequestRetryHandler(Lorg/apache/http/client/HttpRequestRetryHandler;)V
    ...
    invoke-virtual/range {v20 .. v20}, Lcom/lenovo/lps/reaper/sdk/util/Constants$TaskHeaderType$MsgType;->name()Ljava/lang/String;
    ...
    invoke-virtual {v7, v0}, Lorg/apache/http/client/methods/HttpPost;->setURI(Ljava/net/URI;)V

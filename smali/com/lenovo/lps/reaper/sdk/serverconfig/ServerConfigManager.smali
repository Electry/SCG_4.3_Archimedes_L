...
.method private loadServerConfigFromPreferences()V
    ...
    .line 159
    :try_start_0
    const-string v5, "ServerConfigStorage"

    const-string v8, "Loading Configuration From Preferences..."

    invoke-static {v5, v8}, Lcom/lenovo/lps/reaper/sdk/util/TLog;->v(Ljava/lang/String;Ljava/lang/String;)V

    .line 160
    iget-object v5, p0, Lcom/lenovo/lps/reaper/sdk/serverconfig/ServerConfigManager;->context:Landroid/content/Context;

    const-string/jumbo v8, "reaper"
    ...
    invoke-virtual {p0, v5, v8}, Lcom/lenovo/lps/reaper/sdk/serverconfig/ServerConfigManager;->tryAdd(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
    ...
    invoke-static {v5, v8}, Lcom/lenovo/lps/reaper/sdk/util/TLog;->e(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 168
    const-string v5, "LastUpdateTimestamp"
    ...
    .line 170
    .local v6, "timestampMills":J
    invoke-virtual {p0, v6, v7}, Lcom/lenovo/lps/reaper/sdk/serverconfig/ServerConfigManager;->setTimestampMills(J)V
    :try_end_1

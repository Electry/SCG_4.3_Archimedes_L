...
.method private createMovieBox(Lcom/googlecode/mp4parser/authoring/Movie;)Lcom/coremedia/iso/boxes/MovieBox;
    ...
    invoke-virtual {v8, v10, v11}, Lcom/coremedia/iso/boxes/MovieHeaderBox;->setNextTrackId(J)V
    ...
    invoke-direct {v0, v9, v1}, Lcom/googlecode/mp4parser/authoring/builder/DefaultMp4Builder;->createTrackBox(Lcom/googlecode/mp4parser/authoring/Track;Lcom/googlecode/mp4parser/authoring/Movie;)Lcom/coremedia/iso/boxes/TrackBox;
...
.method private createTrackBox(Lcom/googlecode/mp4parser/authoring/Track;Lcom/googlecode/mp4parser/authoring/Movie;)Lcom/coremedia/iso/boxes/TrackBox;
    ...
    invoke-virtual {v0, v4, v5}, Lcom/coremedia/iso/boxes/TrackHeaderBox;->setCreationTime(J)V
    ...
    invoke-virtual {v0, v4, v5}, Lcom/coremedia/iso/boxes/TrackHeaderBox;->setModificationTime(J)V
    ...
    invoke-virtual {v3}, Lcom/googlecode/mp4parser/authoring/TrackMetaData;->getMatrix()[J

    move-result-object v3

    move-object/from16 v0, v39

    invoke-virtual {v0, v3}, Lcom/coremedia/iso/boxes/TrackHeaderBox;->setMatrix([J)V
    ...
    invoke-virtual {v0, v3}, Lcom/coremedia/iso/boxes/TrackHeaderBox;->setVersion(I)V
    ...
    invoke-virtual {v0, v4, v5}, Lcom/coremedia/iso/boxes/MediaHeaderBox;->setCreationTime(J)V
    ...
    invoke-virtual {v0, v3}, Lcom/coremedia/iso/boxes/TimeToSampleBox;->setEntries(Ljava/util/List;)V
    ...
    .end local v13    # "current":Lcom/googlecode/mp4parser/authoring/Track;
    .end local v18    # "firstSampleOfChunk":J
    .end local v23    # "j":I
    :cond_13
    add-int/lit8 v21, v21, 0x1
...
.method public getTimescale(Lcom/googlecode/mp4parser/authoring/Movie;)J
    ...
    invoke-static {v4, v5, v2, v3}, Lcom/googlecode/mp4parser/authoring/builder/DefaultMp4Builder;->gcd(JJ)J

...
.method private readSamples()Z
    ...
    .line 240
    .local v8, "buffered":Ljava/util/ArrayList;, "Ljava/util/ArrayList<[B>;"
    const/4 v10, 0x0
    ...
    invoke-virtual {v0, v9}, Lcom/googlecode/mp4parser/authoring/tracks/H264TrackImpl$ReaderWrapper;->read([B)J
    ...
    sget-object v22, Lcom/googlecode/mp4parser/authoring/tracks/H264TrackImpl;->LOG:Ljava/util/logging/Logger;

    new-instance v23, Ljava/lang/StringBuilder;

    invoke-direct/range {v23 .. v23}, Ljava/lang/StringBuilder;-><init>()V

    const-string v24, "Found startcode at "
    ...
    invoke-direct {v0, v11, v12, v9}, Lcom/googlecode/mp4parser/authoring/tracks/H264TrackImpl;->handleNALUnit(II[B)Lcom/googlecode/mp4parser/authoring/tracks/H264TrackImpl$NALActions;

    move-result-object v5

    .line 253
    .local v5, "action":Lcom/googlecode/mp4parser/authoring/tracks/H264TrackImpl$NALActions;
    sget-object v22, Lcom/googlecode/mp4parser/authoring/tracks/H264TrackImpl$1;->$SwitchMap$com$googlecode$mp4parser$authoring$tracks$H264TrackImpl$NALActions:[I
    ...
    invoke-virtual/range {v22 .. v23}, Lcom/googlecode/mp4parser/authoring/tracks/H264TrackImpl$ReaderWrapper;->seek(I)J
    ...
    invoke-direct {v0, v8}, Lcom/googlecode/mp4parser/authoring/tracks/H264TrackImpl;->createSample(Ljava/util/List;)Ljava/nio/ByteBuffer;
    ...
    .line 272
    .local v7, "bs":Ljava/io/ByteArrayInputStream;
    ...
    const-string v24, "Adding sample with size "
    ...
    .end local v7    # "bs":Ljava/io/ByteArrayInputStream;
    ...
    .line 306
    .end local v5    # "action":Lcom/googlecode/mp4parser/authoring/tracks/H264TrackImpl$NALActions;
    .end local v9    # "data":[B
    .end local v11    # "nal_ref_idc":I
    .end local v12    # "nal_unit_type":I
    .end local v14    # "newpos":J

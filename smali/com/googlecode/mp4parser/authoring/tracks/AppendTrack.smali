...
.method private mergeAudioSampleEntries(Lcom/coremedia/iso/boxes/sampleentry/AudioSampleEntry;Lcom/coremedia/iso/boxes/sampleentry/AudioSampleEntry;)Lcom/coremedia/iso/boxes/sampleentry/AudioSampleEntry;
    ...
    invoke-virtual {v0, v14, v15}, Lcom/coremedia/iso/boxes/sampleentry/AudioSampleEntry;->setBytesPerFrame(J)V
    ...
    invoke-virtual {v0, v14, v15}, Lcom/coremedia/iso/boxes/sampleentry/AudioSampleEntry;->setBytesPerPacket(J)V
    ...
    invoke-virtual {v0, v14, v15}, Lcom/coremedia/iso/boxes/sampleentry/AudioSampleEntry;->setBytesPerSample(J)V
    ...
    invoke-virtual {v0, v14, v15}, Lcom/coremedia/iso/boxes/sampleentry/AudioSampleEntry;->setSampleRate(J)V
    ...
    invoke-virtual {v0, v14, v15}, Lcom/coremedia/iso/boxes/sampleentry/AudioSampleEntry;->setSamplesPerPacket(J)V
...
.method public getDecodingTimeEntries()Ljava/util/List;
    ...
    invoke-interface {v13}, Lcom/googlecode/mp4parser/authoring/Track;->getDecodingTimeEntries()Ljava/util/List;
    ...
    .line 252
    .local v8, "lists":Ljava/util/List;, "Ljava/util/List<[J>;"
    move-object/from16 v0, p0
    ...
    invoke-interface {v12}, Lcom/googlecode/mp4parser/authoring/Track;->getDecodingTimeEntries()Ljava/util/List;
    ...
    invoke-direct {v3, v14, v15, v10, v11}, Lcom/coremedia/iso/boxes/TimeToSampleBox$Entry;-><init>(JJ)V

    .line 261
    .local v3, "e":Lcom/coremedia/iso/boxes/TimeToSampleBox$Entry;
    ...
    .line 263
    .end local v3    # "e":Lcom/coremedia/iso/boxes/TimeToSampleBox$Entry;
    :cond_3
    invoke-virtual {v9}, Ljava/util/LinkedList;->getLast()Ljava/lang/Object;
    ...
    .line 264
    .restart local v3    # "e":Lcom/coremedia/iso/boxes/TimeToSampleBox$Entry;
    ...
    invoke-virtual {v3, v14, v15}, Lcom/coremedia/iso/boxes/TimeToSampleBox$Entry;->setCount(J)V
    ...
    .end local v6    # "len$":I
    .end local v7    # "list":[J
    .end local v8    # "lists":Ljava/util/List;, "Ljava/util/List<[J>;"
    ...
    .end local v10    # "nuDecodingTime":J
    :cond_4
    const/4 v9, 0x0

...
.method public registerApp()Z
    ...
    const-string/jumbo v4, "registerApp() failed winfo == null"
    ...
    const-string/jumbo v4, "registerApp() failed not isWeiboAppSupportAPI"
    ...
    const-string/jumbo v4, "registerApp() failed appkey is null"
    ...
    const-string/jumbo v4, "registerApp() packageName : "
...
.method public registerWeiboDownloadListener(Lcom/sina/weibo/sdk/api/IWeiboDownloadListener;)V
    .locals 0
    .param p1, "listener"    # Lcom/sina/weibo/sdk/api/IWeiboDownloadListener;
...
.method public requestListener(Landroid/content/Intent;Lcom/sina/weibo/sdk/api/IWeiboHandler$Request;)Z
    ...
    .param p2, "handler"    # Lcom/sina/weibo/sdk/api/IWeiboHandler$Request;
    ...
    const-string/jumbo v4, "requestListener() faild appPackage validateSign faild"
    ...
    const-string/jumbo v4, "requestListener() faild intent TRAN is null"
...
.method public responseListener(Landroid/content/Intent;Lcom/sina/weibo/sdk/api/IWeiboHandler$Response;)Z
    .locals 8
    .param p1, "intent"    # Landroid/content/Intent;
    .param p2, "handler"    # Lcom/sina/weibo/sdk/api/IWeiboHandler$Response;
    ...
    const-string/jumbo v6, "responseListener() faild appPackage not equal callPkg"
...
.method public sendRequest(Landroid/app/Activity;Lcom/sina/weibo/sdk/api/BaseRequest;)Z
    ...
    .param p2, "request"    # Lcom/sina/weibo/sdk/api/BaseRequest;
    ...
    const-string/jumbo v5, "sendRequest faild act == null or request == null"
    ...
    const-string/jumbo v5, "sendRequest faild winfo is null"
    ...
    const-string/jumbo v5, "sendRequest faild isWeiboAppSupportAPI"
    ...
    const-string/jumbo v5, "sendRequest faild request check faild"
...
.method public sendResponse(Lcom/sina/weibo/sdk/api/BaseResponse;)Z
    .locals 4
    .param p1, "response"    # Lcom/sina/weibo/sdk/api/BaseResponse;
    ...
    const-string/jumbo v3, "sendResponse failed response null"
    ...
    const-string/jumbo v3, "sendResponse checkArgs fail"
...
.method public startWeibo()Z
    ...
    const-string/jumbo v5, "startWeibo() faild winfo is null"
    ...
    const-string/jumbo v6, "startWeibo() packageName : "
    ...
    const-string/jumbo v5, "startWeibo() faild packageName is null"
